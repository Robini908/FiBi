...
class EditStudent extends Component
{
    ...
    public function save()
    {
        ...
        // Reset edit flags and re-fetch student details
        $this->resetEditFlags();
        $this->fetchStudentDetails();

        // Flash success message
        toast()->success('Student details updated successfully!')->push();
    }
    ...
    public function render()
    {
        ...
        $myClasses = MyClass::orderBy('name')->get();
    ...
    /**
     * Handle the closing action from the UI
     */
    public function handleCloseAction()
    {
        // Using dispatch to communicate with the parent component
        $this->dispatch('closeAction');
    }
}
