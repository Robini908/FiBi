...
class ManageStudents extends Component
{
    ...
    // Add this with the other state properties at the top of the class
    ...
    public function deleteRecord($studentId)
    {
        ...
        $this->resetOtherFlags('isDeleting');
    }

    public function confirmDelete()
    {
        if (!$this->confirmDelete) {
            notify()->warning('Please confirm the deletion by checking the confirmation box.')->push();
            return;
        }
        ...
        if ($this->selectedStudent) {
            ...
            notify()->success("Student $fullName (Admission No: $admNo) deleted successfully from the database.")->push();
        }
    ...
    /**
     * Set up listeners for Livewire events
     *
     * @return array
     */
    ...
    // Add this method to handle opening the admit student form
    public function openAddStudentForm()
    {
        $this->isAddingStudent = true;
        $this->resetOtherFlags('isAddingStudent');
    }
}
