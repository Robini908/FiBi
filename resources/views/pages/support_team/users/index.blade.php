                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        @foreach($user_types as $ut)
                            <a href="#ut-{{ Qs::hash($ut->id) }}" class="dropdown-item" data-toggle="tab">{{ ucfirst($ut->name) }}s</a>
                        @endforeach
                    </div>
                </li>
            </ul>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="user_type"> Select Role: <span class="text-danger">*</span></label>
                                        <select required data-placeholder="Select Role" class="form-control select" name="user_type" id="user_type">
                                            @foreach($user_types as $ut)
                                                <option value="{{ Qs::hash($ut->id) }}">{{ ucfirst($ut->name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
