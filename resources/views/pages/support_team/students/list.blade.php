                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            @endif
                                            @if(Qs::isSuperAdmin())
                                            <a href="{{ route('students.reset_pass', Qs::hash($s->user->id)) }}" class="dropdown-item"><i class="icon-lock"></i> Reset password</a>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            @endif
                                            @if(Qs::isSuperAdmin())
                                            <a href="{{ route('students.reset_pass', Qs::hash($sr->user->id)) }}" class="dropdown-item"><i class="icon-lock"></i> Reset password</a>
                                            <a id="{{ Qs::hash($sr->id) }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                            <form method="post" id="item-delete-{{ Qs::hash($sr->id) }}" action="{{ route('students.destroy', Qs::hash($sr->id)) }}" class="hidden">@csrf @method('delete')</form>
                                            @endif
