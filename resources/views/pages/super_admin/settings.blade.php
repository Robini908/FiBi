...
@section('content')
    ...
    <div class="card  p-2 shadow-lg border rounded" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef);">
                ...
                <div class="row">
                    <div class="col-md-6 border-right-2 border-right-blue-400">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Name of School <span
                        ...
                        <div class="form-group row">
                            <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">Current
                                Session <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <select data-placeholder="Choose..." required name="current_session" id="current_session"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">School Address <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-9">
    ...
    <div class="card  p-2 shadow-lg border rounded" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef);">
        ...
        <livewire:manage-sections-setting />
    </div>

    <div class="card  p-2 shadow-lg border rounded" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef);">
        <livewire:manage-tenants />
    </div>
