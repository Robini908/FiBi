            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Are you sure you want to delete this author? All associated data will be permanently removed. This action cannot be undone.
                    </p>
                    @if(isset($authorToDelete) && $authorToDelete && isset($authorToDelete->books_count) && $authorToDelete->books_count > 0)
                        <div class="mt-2 p-2 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700">
                            <p class="text-sm font-medium">Warning: This author has {{ $authorToDelete->books_count }} {{ Str::plural('book', $authorToDelete->books_count) }} in the library</p>
                            <p class="text-xs mt-1">The books will remain in the system but will no longer be associated with this author.</p>
                        </div>
                    @endif
                </div>
            </div>
