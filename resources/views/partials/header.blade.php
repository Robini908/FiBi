...
<header class="fixed right-0 top-0 md:left-64 left-0 bg-white dark:bg-gray-800 h-16 z-30 shadow-sm border-b border-gray-100 dark:border-gray-700">
    <div class="h-full px-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <!-- Messages Dropdown -->
            <div 
                x-data="{ open: false, unreadCount: {{ Auth::user()->unreadMessages ? Auth::user()->unreadMessages->count() : 0 }} }" 
                class="relative"
                ...
                >
                    <div class="p-4">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <a href="{{ route('messages.index') }}" class="text-xs font-medium text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300">View all</a>
                        </div>
            ...
            <div x-data="{ open: false }" class="relative ml-3">
                ...
                >
                    ...
                    <span class="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-300">{{ Str::limit(Auth::user()->name, 15) }}</span>
