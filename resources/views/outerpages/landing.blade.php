...
@section('content')
    <!-- Hero Section -->
    @include('outerpages.partials.hero')
    
    <!-- Features Section -->
    @include('outerpages.partials.features')
    
    <!-- Testimonials Section -->
    @include('outerpages.partials.testimonials')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex lg:mt-0 lg:ml-10">
                    <a href="{{ route('demo') }}" class="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-green-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        Book a Demo
    ...
    <!-- Contact Section -->
    @include('outerpages.partials.contact')
