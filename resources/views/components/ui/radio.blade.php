...
@php
    ...
    // Common classes
    $baseClasses = 'form-radio shadow-sm focus:ring-opacity-50 transition duration-150 ease-in-out dark:bg-gray-800 dark:checked:bg-current';
    ...
    // Combine all radio classes
    $radioClasses = implode(' ', [$baseClasses, $sizeClasses, $focusClasses, implode(' ', $stateClasses)]);
