            ...
            <div class="flex items-start">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div class="mt-1 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                        ...
                        <div class="text-gray-600">
                            <span class="font-medium text-gray-700">Admitted:</span> {{ $selectedStudent->year_admitted }}
                        </div>
                        <div class="text-gray-600">
                            <span class="font-medium text-gray-700">Status:</span> 
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $selectedStudent->status === 'suspended' ? 'bg-amber-100 text-amber-800' : 'bg-green-100 text-green-800' }}">
                                {{ ucfirst($selectedStudent->status ?? 'Active') }}
                            </span>
                        </div>
                    </div>
                </div>
