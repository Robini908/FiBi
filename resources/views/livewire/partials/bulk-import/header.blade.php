<div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 pb-4 border-b border-gray-200">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Import multiple students at once using an Excel spreadsheet</p>
    </div>
    <div class="mt-4 sm:mt-0 flex space-x-3">
        <a href="{{ route('download.template') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
