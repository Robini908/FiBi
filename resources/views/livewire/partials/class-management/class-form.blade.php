        ...
        >
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <h4 class="text-base font-medium text-gray-900">Streams for {{ $name ?: 'this class' }}</h4>
                    <div>
                        <!-- Stream count badge -->
                        @if (count($streams) > 0)
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {{ count($streams) }} {{ Str::plural('stream', count($streams)) }}
                            </span>
                        @endif
                    </div>
                </div>
