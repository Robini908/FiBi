                ...
                <div class="flex items-center space-x-3">
                    ...
                    @if($hasPaymentPermission)
                        <button
                            ...
                            @endif
                            class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-full font-medium text-sm text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-150 ease-in-out shadow-sm {{ !$selectedStudentId ? 'opacity-50 cursor-not-allowed' : '' }}"
