                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                        {{ ($feeStructure->classroom) ? $feeStructure->classroom->name : 'All Classes' }}
                                    </div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center px-2 py-1 rounded-full text-xs font-medium 
                                        @if($feeStructure->category == 'Tuition')
                                            bg-blue-100 text-blue-800
                                        @elseif($feeStructure->category == 'Transport')
                                            bg-amber-100 text-amber-800
                                        @elseif($feeStructure->category == 'Boarding')
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center font-medium text-gray-800">
                                        KES {{ number_format($feeStructure->amount, 2) }}
                                    </div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                        @if($hasManagePermission)
                                            <button wire:click="toggleStatus({{ $feeStructure->id }})" 
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center">
                                        @if($hasManagePermission)
                                            <button wire:click="toggleMandatory({{ $feeStructure->id }})" 
                                                class="px-2 py-1 rounded-full text-xs font-medium
                                                {{ $feeStructure->is_mandatory ? 'bg-indigo-100 text-indigo-800' : 'bg-gray-100 text-gray-800' }}">
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <div class="text-center space-x-1">
                                        ...
                                        <button wire:click="viewFeeStructure({{ $feeStructure->id }})" 
                                        ...
                                        @if($hasManagePermission)
                                            ...
                                            <button wire:click="editFeeStructure({{ $feeStructure->id }})" 
                                            ...
                                            <button wire:click="copyFeeStructure({{ $feeStructure->id }})" 
                                            ...
                                            <button wire:click="confirmDeleteFeeStructure({{ $feeStructure->id }})" 
                        ...
                        <tr>
                            <td colspan="8" class="p-4 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center py-8">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">{{ $search ? 'Try adjusting your search criteria.' : 'Create your first fee structure to get started.' }}</p>
                                    
                                    @if($hasManagePermission && !$search)
