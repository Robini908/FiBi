    ...
    >
        ...
        <div class="bg-green-50 px-6 pt-5 pb-4 sm:px-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">
                {{ $isEditing ? 'Modify existing payment voucher details' : 'Fill in the details to create a new payment voucher' }}
            </p>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($voteheads as $votehead)
                                    <option value="{{ $votehead->id }}">{{ $votehead->name }} - [Balance: KES {{ number_format($votehead->balance, 2) }}]</option>
                                @endforeach
                            </select>
                            @error('votehead_id') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="form-input w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50"
                            >
                            @error('cheque_number') <p class="mt-1 text-sm text-red-600">{{ $message ?? 'Cheque number is required' }}</p> @enderror
                        </div>
                        @endif
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="form-input w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50"
                            >
                            @error('recipient_id_number') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @if($tempAttachmentPath)
                                <div class="mt-2 flex items-center text-sm text-gray-500">
                                    ...
                                    Existing attachment:
                                    <a href="{{ Storage::url($tempAttachmentPath) }}" target="_blank" class="ml-1 text-green-600 hover:text-green-500">
                                        View
                                    </a>
                                </div>
                            @endif
