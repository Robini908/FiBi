        ...
        >
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">
                    {{ $isEditing ? 'Edit Student Arrear' : 'Add New Student Arrear' }}
                </h3>
                ...
                <form wire:submit.prevent="saveArrear">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            @error('student_id') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="bg-gray-50 p-3 rounded-md">
                            ...
                            <div class="text-sm text-gray-900">
                                {{ $student_name }} ({{ $student_admission_number }})
                            </div>
                            @if($arrears_total > 0)
                            <div class="mt-2 text-sm font-medium text-red-700">
                                Current arrears: KES {{ number_format($arrears_total, 2) }}
                            </div>
                            @endif
                        </div>
                        @endif
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                >
                                @error('previous_year') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('previous_term') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                            </div>
                        </div>
