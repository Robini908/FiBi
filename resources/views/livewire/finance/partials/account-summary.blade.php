...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 sm:p-6 bg-gray-50">
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
        <div class="flex flex-col">
            ...
            <div class="text-3xl font-bold text-gray-800">{{ $summary['totalAccounts'] }}</div>
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
        <div class="flex flex-col">
            ...
            <div class="text-3xl font-bold text-gray-800">{{ $summary['activeAccounts'] }}</div>
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
        <div class="flex flex-col">
            ...
            <div class="text-3xl font-bold {{ $summary['totalBalance'] < 0 ? 'text-red-600' : 'text-green-600' }}">
                KES {{ number_format($summary['totalBalance'], 2) }}
            </div>
