...
<div class="p-4 sm:p-6 bg-white border-b border-gray-200">
    <div class="flex flex-col md:flex-row justify-between space-y-4 md:space-y-0">
        <div class="w-full md:w-1/3 relative">
            ...
            <input 
                ...
                type="text" 
                placeholder="{{ $isStudent ? 'Search descriptions or amounts...' : 'Search students, amounts, or descriptions...' }}" 
        ...
        <div x-data="{ filtersOpen: false }" class="flex items-center space-x-2">
            ...
            >
                ...
                Filters
                @if($classFilter || $yearFilter || $termFilter || $statusFilter)
            ...
            >
                ...
                @if(($isAdmin || $isAccountant || $isParent) && !$isStudent)
                <div class="py-2 px-3">
    ...
    <div class="mt-4 flex flex-wrap items-center gap-2">
        ...
        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
            Class: {{ $classes->firstWhere('id', $classFilter)?->name ?: 'Unknown' }}
