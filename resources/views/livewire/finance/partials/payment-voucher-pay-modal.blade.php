<div
    x-data="{ modalOpen: @entangle('showPayModal').live }"
                ...
                <div class="bg-gray-50 rounded-md p-4 mb-4">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $selectedVoucher->voucher_number }}</dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-xs font-medium text-gray-500">Amount</dt>
                            <dd class="mt-1 text-sm text-green-600 font-medium">KES {{ number_format($selectedVoucher->amount, 2) }}</dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-xs font-medium text-gray-500">Recipient</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $selectedVoucher->recipient_name }}</dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-xs font-medium text-gray-500">Payment Method</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ ucfirst($selectedVoucher->payment_method) }}
