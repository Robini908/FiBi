<!-- Voucher Approve Confirmation Modal -->
<div 
    x-data="{ show: @entangle('showApproveModal').defer }"
    x-show="show" 
    x-cloak
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to approve this payment voucher? Once approved, it will be ready for payment.
                                @if($selectedVoucher)
