            ...
            <div class="grow flex flex-col justify-center">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-3xl font-bold text-gray-800">{{ $totalVouchers }}</div>
                    </div>
                </div>
                <div class="mt-2 border-t pt-2 text-xs text-gray-500 flex justify-between">
                    <span>Pending: {{ $pendingVouchers }}</span>
                    <span>Approved: {{ $approvedVouchers }}</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grow flex flex-col justify-center">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-3xl font-bold text-gray-800">KES {{ number_format($totalAmount, 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grow flex flex-col justify-center">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-3xl font-bold text-gray-800">KES {{ number_format($paidAmount, 2) }}</div>
                    </div>
                </div>
                <div class="mt-2 border-t pt-2 text-xs text-gray-500">
                    <span>Paid Vouchers: {{ $paidVouchers }}</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grow flex flex-col justify-center">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-3xl font-bold text-gray-800">{{ $cancelledVouchers }}</div>
                    </div>
                </div>
                <div class="mt-2 border-t pt-2 text-xs space-y-1">
                    <div class="flex items-center justify-between">
                        <div class="text-gray-500">Overall Status</div>
                        <div class="text-green-500 font-medium">{{ number_format(($paidAmount / ($totalAmount ?: 1)) * 100, 1) }}% paid</div>
                    </div>
                </div>
            </div>
        </div>
