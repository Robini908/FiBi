<!-- Voucher Cancel Confirmation Modal -->
<div 
    x-data="{ show: @entangle('showCancelModal').defer }"
    x-show="show" 
    x-cloak
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to cancel this payment voucher? This action cannot be undone, and the voucher will be marked as cancelled.
                                @if($selectedVoucher)
