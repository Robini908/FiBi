<div class="bg-gradient-to-r from-white to-green-50 rounded-lg shadow-md p-6">
    ...
    <!-- Filters -->
    @include('partials.library.books.filters')
        ...
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow-sm overflow-hidden border border-gray-200 sm:rounded-lg">
                    @include('partials.library.books.table')
                </div>
                </div>
            </div>
        </div>
    ...
    <!-- Form Modal -->
    @include('partials.library.books.form-modal')

    <!-- Delete Confirmation Modal -->
    @include('partials.library.books.delete-modal')
