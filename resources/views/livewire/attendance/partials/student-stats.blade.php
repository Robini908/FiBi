<div class="px-4 py-0 sm:p-6">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900">{{ $stats['total_days'] }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900">{{ $stats['present_days'] }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900">{{ $stats['absent_days'] }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900">{{ $stats['late_days'] }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
                        ...
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900 flex items-center">
                                    ...
                                    @if($stats['attendance_rate'] >= $attendanceThreshold)
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div x-data="{ show: @entangle('showPieChart') }" class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div x-show="show" class="p-4">
                <div class="h-64">
                    @if($stats['total_days'] > 0)
                        <livewire:livewire-pie-chart key="{{ $student->id }}_pie" :pie-chart-model="$this->getAttendancePieChartModel()" />
                    @else
        ...
        <div x-data="{ show: @entangle('showTrend') }" class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            <div class="px-4 py-3 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
            ...
            <div x-show="show" class="p-4">
                <div class="h-64">
                    @if(count($monthlyData) > 0)
                        <livewire:livewire-line-chart key="{{ $student->id }}_trend" :line-chart-model="$this->getAttendanceTrendModel()" />
                    @else
                        <div class="flex items-center justify-center h-full">
