    ...
    <div class="p-4">
        <div class="flex items-start">
            ...
            <div class="ml-3 w-0 flex-1 pt-0.5">
                <p class="text-sm font-medium text-gray-900">Attendance {{ $existingRecord ? 'Updated' : 'Recorded' }}</p>
                <p class="mt-1 text-sm text-gray-500">{{ $existingRecord ? 'Changes have been saved' : 'New attendance record created' }} successfully.</p>
            </div>
