                ...
                <div class="card-body p-5">
                    ...
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-600">Effective from:</span>
                            <span class="badge badge-outline">{{ date('d M, Y', strtotime($gs->effective_date)) }}</span>
                    </div>
                    
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-600">Grades defined:</span>
                            <span class="badge {{ $gs->gradingRanges->count() > 0 ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }} gap-1">
                            {{ $gs->gradingRanges->count() }}
                        </span>
                    </div>
                    
                    @if($gs->gradingRanges->count() == 0)
