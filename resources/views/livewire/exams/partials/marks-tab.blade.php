<div class="overflow-hidden bg-white">
    <div class="bg-white px-6 py-8 text-center">
        ...
        <h3 class="mt-4 text-lg font-medium text-gray-900">Exam Marks Management</h3>
        <p class="mt-2 text-sm text-gray-500 max-w-xl mx-auto">
            This section allows you to enter, edit, and manage student exam marks. You can record scores for individual students or upload marks in bulk using Excel sheets.
        </p>
        <div class="mt-6">
