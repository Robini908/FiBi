    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <dd class="mt-1 text-3xl font-semibold text-gray-900">{{ $consolidationStats['timetables'] }}</dd>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <dd class="mt-1 text-3xl font-semibold text-gray-900">{{ $consolidationStats['classes'] }}</dd>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <dd class="mt-1 text-3xl font-semibold text-gray-900">{{ $consolidationStats['periods'] }}</dd>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <dd class="mt-1 text-3xl font-semibold text-gray-900">{{ $consolidationStats['entries'] }}</dd>
            </div>
        </div>
        
        <div class="bg-white overflow-hidden shadow rounded-lg {{ $consolidationStats['conflicts'] > 0 ? 'border-red-500 border-2' : '' }}">
            <div class="px-4 py-5 sm:p-6">
                <dt class="text-sm font-medium {{ $consolidationStats['conflicts'] > 0 ? 'text-red-500' : 'text-gray-500' }} truncate">Conflicts</dt>
                <dd class="mt-1 text-3xl font-semibold {{ $consolidationStats['conflicts'] > 0 ? 'text-red-600' : 'text-gray-900' }}">{{ $consolidationStats['conflicts'] }}</dd>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow overflow-x-auto rounded-lg border border-gray-200">
        <div class="p-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Showing consolidated view grouped by {{ ucfirst($consolidationOptions['group_by']) }}.
                <span class="font-medium">Sessions:</span> {{ $consolidationStats['academic_sessions'] }} |
                <span class="font-medium">Terms:</span> {{ $consolidationStats['academic_terms'] }}
            </p>
        </div>
        
        <div class="overflow-x-auto">
            @if($consolidationOptions['group_by'] === 'teacher')
                @include('livewire.timetable.partials.consolidated-teacher-view')
            @elseif($consolidationOptions['group_by'] === 'class')
                @include('livewire.timetable.partials.consolidated-class-view')
            @elseif($consolidationOptions['group_by'] === 'subject')
                @include('livewire.timetable.partials.consolidated-subject-view')
            @else
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    @if($consolidationOptions['highlight_conflicts'])
                        <div class="flex items-center">
