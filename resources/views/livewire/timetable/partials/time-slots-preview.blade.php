<div @click.stop x-data="{
    ...
    init() {
        ...
        this.startTime = @js($autoGenerateForm['school_start_time'] ?? '08:00');
        this.endTime = @js($autoGenerateForm['school_end_time'] ?? '15:30');
        this.lessonDuration = parseInt(@js($autoGenerateForm['lesson_duration'] ?? 40));
        this.breakDuration = parseInt(@js($autoGenerateForm['break_duration'] ?? 15));
        this.includeBreaks = Boolean(@js($autoGenerateForm['include_breaks'] ?? false));
        this.includeLunch = Boolean(@js($autoGenerateForm['include_lunch'] ?? false));
        this.lunchTime = @js($autoGenerateForm['lunch_time'] ?? '12:30');
        this.lunchDuration = parseInt(@js($autoGenerateForm['lunch_duration'] ?? 40));
        this.includeTransitions = Boolean(@js($autoGenerateForm['include_transitions'] ?? false));
        this.transitionTime = parseInt(@js($autoGenerateForm['transition_duration'] ?? 5));
        this.includeExtracurricular = Boolean(@js($autoGenerateForm['include_extracurricular'] ?? false));
        this.extracurricularStartTime = @js($autoGenerateForm['extracurricular_start_time'] ?? '15:30');
        this.extracurricularEndTime = @js($autoGenerateForm['extracurricular_end_time'] ?? '17:00');
        this.includeWeekendClasses = Boolean(@js($autoGenerateForm['include_weekend_classes'] ?? false));
        this.weekendDay = @js($autoGenerateForm['weekend_day'] ?? 'saturday');
        this.weekendStartTime = @js($autoGenerateForm['weekend_start_time'] ?? '09:00');
        this.weekendEndTime = @js($autoGenerateForm['weekend_end_time'] ?? '13:00');
        this.weekendLessonDuration = parseInt(@js($autoGenerateForm['weekend_lesson_duration'] ?? 60));
        this.includeMorningPrep = Boolean(@js($autoGenerateForm['include_morning_prep'] ?? false));
        this.morningPrepStartTime = @js($autoGenerateForm['morning_prep_start_time'] ?? '06:00');
        this.morningPrepEndTime = @js($autoGenerateForm['morning_prep_end_time'] ?? '07:30');
        this.includeEveningPrep = Boolean(@js($autoGenerateForm['include_evening_prep'] ?? false));
        this.eveningPrepStartTime = @js($autoGenerateForm['evening_prep_start_time'] ?? '19:00');
        this.eveningPrepEndTime = @js($autoGenerateForm['evening_prep_end_time'] ?? '21:00');
