    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <select id="section_id" wire:model.live="selectedSectionId" class="pl-10 pr-10 py-2 border-gray-300 focus:ring-green-500 focus:border-green-500 block w-full text-sm rounded-md" @if(empty($sections)) disabled @endif>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <select id="exam_id" wire:model.live="selectedExamId" class="pl-10 pr-10 py-2 border-gray-300 focus:ring-green-500 focus:border-green-500 block w-full text-sm rounded-md" @if(empty($exams)) disabled @endif>
