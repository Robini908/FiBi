    ...
    <div class="py-3">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                @error('autoGenerateForm.break_after_lessons') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                @error('autoGenerateForm.break_duration') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
        </div>
    </div>
    ...
    <div class="py-3 border-t border-gray-100">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                @error('autoGenerateForm.lunch_duration') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
        </div>
    </div>
    ...
    <div class="py-3 border-t border-gray-100">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                @error('autoGenerateForm.transition_duration') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
        </div>
