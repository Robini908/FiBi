<div 
    x-data="{ 
        activeTab: 'profile', 
        showSuccessMessage: @entangle('showSuccessMessage'),
        showErrorMessage: @entangle('showErrorMessage'),
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-3 space-y-6">
                @include('livewire.partials.user-profile.header')
            </div>
            ...
            <div class="lg:col-span-9 space-y-6">
                ...
                @include('livewire.partials.user-profile.tabs')
                
                <!-- Tab Content -->
                <div class="space-y-6">
                    <div x-show="activeTab === 'profile'">
                        @include('livewire.partials.user-profile.photo-manager')
                        @include('livewire.partials.user-profile.profile-form')
                    </div>
                    
                    <div x-show="activeTab === 'password'">
                        @include('livewire.partials.user-profile.password-form')
                    </div>
                </div>
            </div>
        </div>
