...
<head>
    ...
    <title>Timetable - <?php echo e($timetable->name); ?></title>
    <style>
        @media print {
            @page {
                size: landscape;
    ...
    <div class="print-container">
        <div class="page-header">
            <div class="school-info">
                <?php if($schoolLogo): ?>
                <img src="<?php echo e($schoolLogo); ?>" alt="<?php echo e($schoolName); ?>" class="school-logo">
                <?php endif; ?>
                <div>
            ...
            <div class="timetable-info">
                <div class="timetable-info-item">
                    ...
                    <span><strong>Timetable:</strong> <?php echo e($timetable->name); ?></span>
                </div>
                ...
                <div class="timetable-info-item">
                    ...
                    <span><strong>Class:</strong> <?php echo e($timetable->myClass->name ?? 'Not specified'); ?></span>
                </div>
                ...
                <div class="timetable-info-item">
                    ...
                    <span><strong>Section:</strong> <?php echo e($section->name); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="timetable-info-item">
                    ...
                    <span><strong>Academic Year:</strong> <?php echo e($timetable->academic_session); ?></span>
                </div>
                ...
                <div class="timetable-info-item">
                    ...
                    <span><strong>Term:</strong> <?php echo e($timetable->academic_term); ?></span>
                </div>
                ...
                <div class="timetable-info-item">
                    ...
                    <span><strong>Generated:</strong> <?php echo e(now()->format('d M Y, h:i A')); ?></span>
                </div>
            </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <?php $__currentLoopData = $visibleDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $isCurrentDay = strtolower(date('l')) == $day;
                            $headerClass = $isCurrentDay ? 'current-day' : '';
                        ?>
                        <th class="<?php echo e($headerClass); ?>"><?php echo e(ucfirst($day)); ?></th>
                    ...
                    <tr>
                        <td class="time-slot">
                            ...
                            <div class="period-time">
                                <?php echo e(date('h:i A', strtotime($period->start_time))); ?> - <?php echo e(date('h:i A', strtotime($period->end_time))); ?>
                        ...
                        <?php $__currentLoopData = $visibleDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="<?php echo e($slotClass); ?>">
                                <?php if($entry): ?>
                                    <div class="class-entry">
                                        <div class="entry-subject"><?php echo e($entry->subject->subject_name ?? 'No Subject'); ?></div>
                                        <div class="entry-teacher"><?php echo e($entry->teacher->name ?? 'Not Assigned'); ?></div>
                                        <?php if($entry->classroom): ?>
                                            <div class="entry-room"><?php echo e($entry->classroom); ?></div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
        ...
        <div class="footer">
            ...
            <p>Generated from <?php echo e(config('app.name', 'School Management System')); ?> on <?php echo e(now()->format('d M Y, h:i A')); ?></p>
        </div>
    </div>
</body>
</html> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/exports/timetable-print.blade.php ENDPATH**/ ?>