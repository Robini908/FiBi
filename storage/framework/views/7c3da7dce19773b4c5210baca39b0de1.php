<div x-data="{ 
    ...
    <?php echo $__env->make('livewire.partials.combination-formula._header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <div class="space-y-6">
        <!-- Normal Analysis Tab -->
        <div x-show="activeTab === 'normal'" x-cloak>
            <!--[if BLOCK]><![endif]--><?php if(!$showTable): ?>
                <?php echo $__env->make('livewire.partials.combination-formula._filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('livewire.partials.combination-formula._exam-display', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
                <!-- Analysis Results -->
                <div class="space-y-6">
                    <!-- Back Button -->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(count($selectedExams) > 1): ?>
                        <?php echo $__env->make('livewire.partials.combination-formula._results-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php else: ?>
                        <?php echo $__env->make('livewire.partials.combination-formula._single-exam-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div x-show="activeTab === 'combined'" x-cloak>
            <?php echo $__env->make('livewire.partials.combination-formula._filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('livewire.partials.combination-formula._exam-display', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('livewire.partials.combination-formula._exam-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('livewire.partials.combination-formula._exam-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('livewire.partials.combination-formula._results-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/combination-formula.blade.php ENDPATH**/ ?>