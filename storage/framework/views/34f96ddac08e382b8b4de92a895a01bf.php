<div class="py-12 flex flex-col items-center justify-center text-center">
    ...
    <div class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-blue-50 text-blue-700 mb-3">
        ...
        Viewing: <?php echo e($academicYear); ?> - <?php echo e($academicTerm); ?>

    </div>
    
    <p class="text-base text-gray-500 mb-6 max-w-lg">
        <!--[if BLOCK]><![endif]--><?php if(!empty($search) || !empty($filterTeacher) || !empty($filterSubject) || !empty($filterClass)): ?>
            No assignments match your current filter settings. Try adjusting your filters or create a new assignment.
        <?php else: ?>
            No teacher-subject assignments have been created for <?php echo e($academicYear); ?> - <?php echo e($academicTerm); ?>. Get started by adding your first assignment.
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </p>
    
    <div class="flex flex-col sm:flex-row gap-3">
        <?php if(!empty($search) || !empty($filterTeacher) || !empty($filterSubject) || !empty($filterClass) || !empty($filterStatus) || !empty($filterPrimary)): ?>
            <button 
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/subject-teacher-assignment/empty-state.blade.php ENDPATH**/ ?>