    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex justify-between items-center">
            <h3 class="text-lg font-medium text-gray-900">
                Entries for <?php echo e($selectedClass->name); ?>
    ...
    <div class="px-6 py-4">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border border-gray-200 rounded-md p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    <?php echo e($genderBalance['male']); ?>

                                </span>
                            </div>
                            <div class="mt-3 max-h-32 overflow-y-auto text-xs text-gray-600 bg-gray-50 rounded-md p-3">
                                <?php echo e($genderBalance['male_names'] ?: 'No male students in this class.'); ?>
                        ...
                        <div class="border border-gray-200 rounded-md p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-800">
                                    <?php echo e($genderBalance['female']); ?>

                                </span>
                            </div>
                            <div class="mt-3 max-h-32 overflow-y-auto text-xs text-gray-600 bg-gray-50 rounded-md p-3">
                                <?php echo e($genderBalance['female_names'] ?: 'No female students in this class.'); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $studentsByParent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="border border-gray-200 rounded-md p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <h4 class="text-sm font-medium text-gray-900"><?php echo e($parent['parent_name']); ?></h4>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <ul class="divide-y divide-gray-200">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $parent['students']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="py-2">
                                                <div class="flex justify-between">
                                                    <span class="text-sm font-medium text-gray-900"><?php echo e($student['name']); ?></span>
                                                    <span class="text-sm text-gray-500"><?php echo e($student['year_admitted']); ?></span>
                                                </div>
                                                <p class="text-xs text-gray-500"><?php echo e($student['status']); ?></p>
                                            </li>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/class-management/entries-panel.blade.php ENDPATH**/ ?>