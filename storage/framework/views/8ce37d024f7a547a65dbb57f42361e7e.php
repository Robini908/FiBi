<div class="overflow-x-auto bg-white shadow-sm rounded-lg">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-green-50 transition-colors duration-150">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-12 w-12 relative">
                                <!--[if BLOCK]><![endif]--><?php if($book->cover_image): ?>
                                    <img class="h-12 w-12 object-cover rounded-md shadow-sm" src="<?php echo e(asset('storage/' . $book->cover_image)); ?>" alt="<?php echo e($book->title); ?>">
                                <?php else: ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($book->is_featured): ?>
                        ...
                        <div class="text-sm text-gray-900">
                            <!--[if BLOCK]><![endif]--><?php if(count($book->authors) > 0): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $book->authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <!--[if BLOCK]><![endif]--><?php if($author->pivot && $author->pivot->is_primary): ?>
                                        ...
                                        <?php else: ?>
                                            <span class="text-gray-600"><?php echo e($author->name); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </li>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex flex-col items-start">
                            <div class="text-sm font-medium">
                                <!--[if BLOCK]><![endif]--><?php if($book->copies_available > 0): ?>
                                    <span class="inline-flex items-center text-green-600">
                                        <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                        </svg>
                                        <?php echo e($book->copies_available); ?> / <?php echo e($book->total_copies); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($book->copies_available === 0 && $book->total_copies > 0): ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <!--[if BLOCK]><![endif]--><?php if($book->is_active): ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end space-x-2">
                            <!-- View Details -->
                            <a href="<?php echo e(route('library.catalog', ['book_id' => $book->id])); ?>" 
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasAnyRole(['librarian', 'admin', 'superadmin'])): ?>
                                <!-- Edit Button -->
                                <button wire:click="edit(<?php echo e($book->id); ?>)" 
                                ...
                                <!-- Inventory Button -->
                                <a href="<?php echo e(route('library.inventory', ['book_id' => $book->id])); ?>" 
                                ...
                                <!-- Delete Button -->
                                <button wire:click="confirmDelete(<?php echo e($book->id); ?>)" 
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/partials/library/books/table.blade.php ENDPATH**/ ?>