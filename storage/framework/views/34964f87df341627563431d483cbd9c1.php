<div x-data="{ focused: false, hasResults: false }" class="relative w-full">
    ...
    >
        <ul class="py-1 divide-y divide-gray-100 dark:divide-gray-700">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <a 
                    ...
                    >
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400 flex items-center mt-1">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($student->town): ?>
                                    <span class="ml-2"><?php echo e($student->town); ?></span>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/intelligent-search.blade.php ENDPATH**/ ?>