    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-6 bg-gray-50 dark:bg-gray-100 border-t border-gray-200 dark:border-gray-200">
        ...
        <div class="bg-white dark:bg-white rounded-lg shadow-sm p-4 flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-800"><?php echo e($dorms->count()); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-white rounded-lg shadow-sm p-4 flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-800"><?php echo e($dorms->sum('capacity')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-white rounded-lg shadow-sm p-4 flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-800"><?php echo e($totalOccupancy); ?> / <?php echo e($totalCapacity); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-white rounded-lg shadow-sm p-4 flex items-center space-x-4">
            ...
            <div>
                ...
                <div class="flex items-center">
                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-800"><?php echo e(round($occupancyPercentage)); ?>%</p>
                    <div class="ml-2 flex h-2 w-16 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-200">
                        <div 
                            ...
                            :class="{
                                'bg-green-500': <?php echo e($occupancyPercentage); ?> < 70,
                                'bg-yellow-500': <?php echo e($occupancyPercentage); ?> >= 70 && <?php echo e($occupancyPercentage); ?> < 90,
                                'bg-red-500': <?php echo e($occupancyPercentage); ?> >= 90
                            }"
                        ></div>
                    </div>
                </div>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/dorms/header.blade.php ENDPATH**/ ?>