<!-- Combined Exam Form -->
<!--[if BLOCK]><![endif]--><?php if($showCombinedExamForm && count($selectedExams) > 1): ?>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            ...
                            <ul class="mt-2 list-disc list-inside space-y-1">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedExamNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $examName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($examName); ?> (<?php echo e($gradingSystemNames[$index] ?? 'Unknown Grading'); ?>)</li>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customExamName'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <div class="mt-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customExamTerm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <div class="mt-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customExamYear'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/combination-formula/_exam-form.blade.php ENDPATH**/ ?>