            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-red-700">
                        <p>You are about to expel <strong><?php echo e($selectedStudent->first_name); ?> <?php echo e($selectedStudent->last_name); ?></strong> from the school system.</p>
        ...
        <div class="space-y-4">
                <div>
                    ...
                    <div>
                        ...
                        ></textarea>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['expulsionReason'];
                ...
                <label for="expulsionDate" class="block text-sm font-medium text-gray-700 mb-1">Effective Date</label>
                    <div>
                        <input 
                            ...
                            class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md"
                        >
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['expulsionDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="pt-4 border-t border-gray-200">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['confirmExpulsion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/students/student-expulsion.blade.php ENDPATH**/ ?>