    ...
    <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center">
            ...
            <div class="ml-3 flex items-center">
                <span class="text-xs text-gray-500 mr-2">Last updated: <?php echo e($lastUpdated ?? now()->format('Y-m-d H:i:s')); ?></span>
                <span class="flex h-3 w-3 relative">
                    <span class="<?php echo e($pollingEnabled ? 'animate-ping' : ''); ?> absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-3 w-3 <?php echo e($pollingEnabled ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                </span>
            </div>
        </div>
        <div class="flex space-x-2">
            <!-- Toggle Automatic Refresh -->
            <button wire:click="togglePolling" class="inline-flex items-center px-3 py-1.5 border <?php echo e($pollingEnabled ? 'border-green-700 bg-green-600 text-white' : 'border-gray-300 text-gray-700 bg-white'); ?> text-xs font-medium rounded shadow-sm hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
                <?php echo e($pollingEnabled ? 'Auto-refresh On' : 'Auto-refresh Off'); ?>
...
<div class="px-4 py-5 sm:p-6 bg-gray-50 border-b border-gray-200">
    ...
    <div class="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-3 relative">
        ...
        <div>
            ...
            <div class="relative">
                <select id="sectionId" wire:model.live="sectionId" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" <?php echo e(empty($classId) ? 'disabled' : ''); ?>>
        ...
        <div>
            ...
            <div class="relative">
                <div class="flex items-center">
                    <input id="analytics-date-range" type="text" placeholder="Select date range" class="block w-full pr-10 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e($startDate); ?> to <?php echo e($endDate); ?>">
    ...
    <div class="mt-4 flex flex-wrap gap-2">
        ...
        <!--[if BLOCK]><![endif]--><?php if($activeTab === 'trends'): ?>
            <div class="ml-auto">
...
<div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-t border-gray-200">
    <div class="flex items-center text-sm text-gray-600">
        ...
        <span>Last updated: <?php echo e(now()->format('M d, Y h:i:s A')); ?></span>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/attendance/partials/analytics-header.blade.php ENDPATH**/ ?>