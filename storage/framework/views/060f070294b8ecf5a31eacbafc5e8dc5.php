        ...
        <div class="mt-12 sm:mt-16 relative" x-data="{ annual: true }">
            ...
            <div class="space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
                ...
                <div class="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
                    ...
                    <a href="<?php echo e(route('demo')); ?>" class="mt-8 block w-full bg-white border border-gray-300 rounded-lg py-3 px-6 text-center font-medium text-blue-600 hover:bg-gray-50 hover:border-blue-600 transition-colors duration-200">Book a Demo</a>
                </div>
                ...
                <div class="relative p-8 bg-blue-50 border border-blue-200 rounded-2xl shadow-sm flex flex-col">
                    ...
                    <a href="<?php echo e(route('demo')); ?>" class="mt-8 block w-full bg-blue-600 border border-transparent rounded-lg py-3 px-6 text-center font-medium text-white hover:bg-blue-700 transition-colors duration-200 shadow-sm">Book a Demo</a>
                </div>
            ...
            <div class="mt-16 border-t border-gray-200 pt-16 lg:grid lg:grid-cols-3 lg:gap-x-8">
                ...
                <div class="mt-8 lg:mt-0 lg:col-span-2">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('contact')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-500">
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/outerpages/partials/pricing.blade.php ENDPATH**/ ?>