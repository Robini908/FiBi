            ...
            <div x-show="showStudentSidebar" 
                ...
                <div class="p-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 sticky top-0 z-10">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        <?php echo e(count($selectedStudents)); ?> student(s) selected for transition
                    </p>
                </div>
                    ...
                    <ul class="space-y-3">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-blue-50 hover:border-blue-300 hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5"
                                x-transition:enter="transition ease-out duration-300 delay-<?php echo e($index * 100); ?>"
                                ...
                                <div class="ml-3 flex-1">
                                    <h4 class="text-sm font-medium text-gray-900"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></h4>
                                    <div class="flex items-center text-xs text-gray-500 mt-0.5">
                                        <i class="fas fa-id-card text-gray-400 mr-1"></i>
                                        <span><?php echo e($student->adm_no); ?></span>
                                    </div>
                                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['transitionYear'];
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" readonly 
                                    ...
                                    value="<?php echo e($transitionType === 'repetition' ? $transitionYear : $transitionYear + 1); ?>">
                            </div>
                            <p class="mt-1 text-xs text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($transitionType === 'repetition'): ?>
                ...
                <div class="mb-6">
                    <h3 class="text-md font-medium text-gray-800 mb-4">Class Information</h3>
                            ...
                            <div class="flex flex-col items-center justify-center p-3 bg-white rounded-md border border-blue-100">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($currentClass && $targetClassObj): ?>
                                        ...
                                        <div class="text-center w-1/3">
                                            <div class="mx-auto w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center border border-gray-300 mb-2 relative"
                                                ...
                                                <template x-if="animateTransition">
                                                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min(count($selectedStudents), 5); $i++): ?>
                                                        <div class="absolute top-1/2 left-1/2 w-4 h-4 rounded-full bg-blue-500 transition-all duration-2000 delay-<?php echo e($i * 200); ?>"
                                            ...
                                            <div class="font-medium text-gray-900"
                                                ...
                                                <?php echo e($currentClass->name); ?>

                                            </div>
                                            <div class="text-xs text-gray-500 mt-1"
                                                :class="{'transition-all duration-1000 ease-in-out opacity-50': animateTransition}">
                                        Current Class (<?php echo e($transitionYear); ?>)
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center w-1/3">
                                            <div class="mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-2 relative transition-all duration-1000"
                                                 :class="{
                                                    ...
                                                    'bg-emerald-100 border border-emerald-300': '<?php echo e($transitionType); ?>' === 'promotion',
                                                    'bg-red-100 border border-red-300': '<?php echo e($transitionType); ?>' === 'demotion',
                                                    'bg-amber-100 border border-amber-300': '<?php echo e($transitionType); ?>' === 'repetition'
                                                 }">
                                                <i class="fas fa-users transition-all duration-500" 
                                                   :class="{
                                                        'transform scale-125': animateTransition,
                                                        'text-emerald-600': '<?php echo e($transitionType); ?>' === 'promotion',
                                                        'text-red-600': '<?php echo e($transitionType); ?>' === 'demotion',
                                                        'text-amber-600': '<?php echo e($transitionType); ?>' === 'repetition'
                                                   }"></i>
                                            </div>
                                            <div class="font-medium transition-all duration-500"
                                                 :class="{
                                                    'transform scale-105': animateTransition,
                                                    'text-emerald-800': '<?php echo e($transitionType); ?>' === 'promotion',
                                                    'text-red-800': '<?php echo e($transitionType); ?>' === 'demotion',
                                                    'text-amber-800': '<?php echo e($transitionType); ?>' === 'repetition'
                                                 }"><?php echo e($targetClassObj->name); ?></div>
                                            <div class="text-xs mt-1 transition-all duration-500"
                                                 :class="{
                                                    'text-emerald-600': '<?php echo e($transitionType); ?>' === 'promotion',
                                                    'text-red-600': '<?php echo e($transitionType); ?>' === 'demotion',
                                                    'text-amber-600': '<?php echo e($transitionType); ?>' === 'repetition'
                                         }">Target Class (<?php echo e($transitionType === 'repetition' ? $transitionYear : $transitionYear + 1); ?>)</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 text-sm text-gray-700 text-center">
                                        <p>
                                            <!--[if BLOCK]><![endif]--><?php if($transitionType === 'promotion'): ?>
                                                ...
                                                <span class="font-medium text-blue-700"><?php echo e(count($selectedStudents)); ?> student(s)</span> 
                                                <span class="text-gray-600">from</span> 
                                                <span class="font-medium text-gray-700"><?php echo e($currentClass->name); ?></span> 
                                                <span class="text-gray-600">to</span> 
                                                <span class="font-medium text-emerald-600"><?php echo e($targetClassObj->name); ?></span>
                                        <span class="text-gray-600">for the academic year</span>
                                        <span class="font-medium text-blue-700"><?php echo e($transitionYear + 1); ?></span>
                                            <?php elseif($transitionType === 'demotion'): ?>
                                                ...
                                                <span class="font-medium text-gray-700"><?php echo e($currentClass->name); ?></span> 
                                                <span class="text-gray-600">to</span> 
                                                <span class="font-medium text-red-600"><?php echo e($targetClassObj->name); ?></span>
                                        <span class="text-gray-600">for the academic year</span>
                                        <span class="font-medium text-blue-700"><?php echo e($transitionYear + 1); ?></span>
                                            <?php elseif($transitionType === 'repetition'): ?>
                                        ...
                                        <span class="text-gray-600">repeat</span> 
                                                <span class="font-medium text-amber-600"><?php echo e($currentClass->name); ?></span>
                                        <span class="text-gray-600">for the academic year</span>
                                        <span class="font-medium text-blue-700"><?php echo e($transitionYear); ?></span>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </p>
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="mb-6">
                    ...
                    <div>
                        <label for="reason" class="block text-sm font-medium text-gray-700 mb-1">
                            Reason for <?php echo e($transitionType === 'promotion' ? 'Promotion' : ($transitionType === 'demotion' ? 'Demotion' : 'Repetition')); ?>

                            <!--[if BLOCK]><![endif]--><?php if($transitionType !== 'promotion'): ?> <span class="text-red-500">*</span> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </label>
                        <div class="relative">
                            ...
                            <textarea wire:model="reason" id="reason" rows="3" 
                                class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                placeholder="<?php echo e($transitionType === 'promotion' ? 'Optional reason for promotion' : 'Required reason for ' . $transitionType); ?>"></textarea>
                        </div>
                        <p class="mt-1 text-xs text-gray-500">
                            <!--[if BLOCK]><![endif]--><?php if($transitionType === 'promotion'): ?>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/promote-students/transition-details.blade.php ENDPATH**/ ?>