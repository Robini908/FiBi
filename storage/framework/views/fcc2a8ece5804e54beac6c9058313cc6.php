            ...
            <div class="flex items-center justify-between mb-2">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        <?php echo e(($selectedClass ? 1 : 0) + ($selectedExam ? 1 : 0) + ($selectedSubject ? 1 : 0)); ?>/3
                    </span>
                </div>
                <!--[if BLOCK]><![endif]--><?php if($selectedClassName): ?>
                    <span class="text-sm text-gray-500"><?php echo e($selectedClassName); ?></span>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
            <div class="w-full bg-gray-200 rounded-full h-1">
                <div class="bg-blue-600 h-1 rounded-full transition-all duration-300"
                     style="width: <?php echo e((($selectedClass ? 1 : 0) + ($selectedExam ? 1 : 0) + ($selectedSubject ? 1 : 0)) * 33.33); ?>%">
                </div>
            </div>
        </div>
            ...
            <div class="relative" wire:key="exam-selection">
                ...
                <div class="relative">
                    <select wire:model.live="selectedExam" 
                            id="exam" 
                            <?php if(!$selectedClass): ?> disabled <?php endif; ?>
            ...
            <div class="relative" wire:key="subject-selection">
                ...
                <div class="relative">
                    <select wire:model.live="selectedSubject" 
                            id="subject" 
                            <?php if(!$selectedExam): ?> disabled <?php endif; ?>
                            class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-lg disabled:bg-gray-50 disabled:text-gray-500">
            ...
            <div class="mt-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div class="flex flex-wrap gap-3">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                        <?php echo e($selectedExamName); ?>

                    </span>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                        <?php echo e($selectedSubjectName); ?>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            If you don't see the exam you're looking for, you may need to create it first.
                            <a href="<?php echo e(route('exams.modern-management')); ?>" class="font-medium underline hover:text-blue-600 transition-colors duration-150">
                                Go to Modern Exam Management
                            </a>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/exam-marks/filters.blade.php ENDPATH**/ ?>