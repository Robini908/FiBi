    ...
    <div class="py-4 h-full">
        <nav class="px-3 space-y-1.5">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" 
               class="<?php echo e(Request::is('dashboard*') ? 'bg-green-50 text-green-700 border-l-4 border-green-500' : 'text-gray-600 hover:bg-gray-50 hover:text-green-700'); ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-colors duration-150">
            ...
            <div class="py-1">
                ...
                <div x-show="activeMenu === 'academics'"
                    ...
                    <a href="<?php echo e(Qs::isParent() ? route('parent.child-exams') : (Qs::isStudent() ? route('student.my-exams') : route('exams.set'))); ?>"
                       class="<?php echo e(in_array(Route::currentRouteName(), ['exams.set', 'parent.child-exams', 'student.my-exams']) ? 'text-green-700 font-medium' : 'text-gray-600 hover:text-green-700'); ?> group flex items-center py-2 text-sm rounded-md">
