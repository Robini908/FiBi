...
<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    <div x-data="{ activeTab: '<?php echo e(Qs::userIsParent() ? 'admit-student' : 'manage-students'); ?>' }">
        <!-- Header with tabs -->
        <div class="border-b border-gray-200">
            ...
            <?php endif; ?>
                    ...
                    <button @click="activeTab = 'admit-student'" 
                            ...
                            class="group <?php echo e(!Qs::userIsParent() ? 'ml-8' : ''); ?> inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors whitespace-nowrap">
                        ...
                        <?php echo e(Qs::userIsParent() ? 'Admit My Child' : 'Admit New Student'); ?>
                    ...
                    <button @click="activeTab = 'manage-suspensions'" 
                        ...
                        <?php echo e(Qs::userIsParent() ? 'My Child\'s Suspensions' : 'Manage Suspensions'); ?>
...
[$__name, $__params] = $__split('manage-students', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2326388021-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('admit-student', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2326388021-1', $__slots ?? [], get_defined_vars());
                ...
                <div class="bg-yellow-50 rounded-lg p-4 mb-6 flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-yellow-800">
                            <?php echo e(Qs::userIsParent() ? 'Child Suspension Records' : 'Suspension Management'); ?>
...
[$__name, $__params] = $__split('manage-suspensions', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2326388021-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('addbulk', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2326388021-3', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/pages/support_team/students/manage-students.blade.php ENDPATH**/ ?>