...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="flex justify-center">
            <i class="text-green-600 text-5xl mb-4 fa fa-graduation-cap" aria-hidden="true"></i>
        </div>
            ...
            <form class="space-y-6" method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="mt-1 relative">
                        ...
                        <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-500">
                            ...
                            <svg x-show="show" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="display: none;">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox" <?php echo e(old('remember') ? 'checked' : ''); ?> class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/auth/login.blade.php ENDPATH**/ ?>