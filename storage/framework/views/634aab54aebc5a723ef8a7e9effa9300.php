<div class="bg-gray-50 rounded-lg overflow-hidden shadow-sm" x-data="{ 
    initialized: false,
    selectedTab: <?php if ((object) ('activeTab') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'->value()); ?>')<?php echo e('activeTab'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'); ?>')<?php endif; ?>,
    ...
    <div class="relative overflow-hidden" 
        ...
        <div x-show="currentView === 'main'" class="p-6 space-y-6 bg-gray-50">
            ...
            <!-- Section Selection -->
                        <div x-bind:class="{'opacity-50': !$wire.selectedClassId}">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                ...
                                <select id="section" wire:model.live="selectedSectionId" class="pl-7 block w-full rounded-lg border-gray-200 shadow-sm focus:border-green-500 focus:ring-green-500 text-xs py-2 bg-gray-50 hover:bg-white transition-colors duration-200" <?php if(empty($sections)): ?> disabled <?php endif; ?>>
            ...
            <!--[if BLOCK]><![endif]--><?php if($selectedClassId): ?>
                    <div class="mt-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $timetableRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($record->id); ?>"><?php echo e($record->name); ?> <?php echo e($record->is_active ? '(Active)' : ''); ?></option>
                ...
                <!--[if BLOCK]><![endif]--><?php if(empty($timetableRecords) || count($timetableRecords) === 0): ?>
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2">
                ...
                <div class="bg-white rounded-xl border border-gray-100 hover:border-green-200 shadow-sm hover:shadow transition-all duration-300 overflow-hidden group">
                    <div class="p-6">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selectedTimetableRecord): ?>
                        <div class="mb-2 text-xs text-green-600 font-medium">
                            <span>Selected: <?php echo e(collect($timetableRecords)->firstWhere('id', $selectedTimetableRecord)->name ?? 'Unknown'); ?></span>
                        </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="bg-white rounded-xl border border-gray-100 hover:border-green-200 shadow-sm hover:shadow transition-all duration-300 overflow-hidden group">
                    <div class="p-6">
                        ...
                        <a href="<?php echo e(route('tt.consolidator')); ?>" class="w-full block text-center mt-2 px-4 py-2.5 rounded-full text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
                            Open Consolidator
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 hover:border-green-200 shadow-sm hover:shadow transition-all duration-300 overflow-hidden group">
                    <div class="p-6">
                        ...
                        <a href="<?php echo e(route('exam.timetable')); ?>" class="w-full block text-center mt-2 px-4 py-2.5 rounded-full text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
...
[$__name, $__params] = $__split('timetable.timetable-records', [
                'classId' => $selectedClassId,
                'term' => $selectedTerm,
                'session' => $selectedSession
            ]);

$__html = app('livewire')->mount($__name, $__params, 'timetable-records-' . $selectedClassId . '-' . $selectedTerm . '-' . $selectedSession, $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('timetable.time-slots', [
                'timetableRecordId' => $selectedTimetableRecord
            ]);

$__html = app('livewire')->mount($__name, $__params, 'time-slots-' . $selectedTimetableRecord, $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('timetable.timetable-view', [
                'timetableRecordId' => $selectedTimetableRecord,
                'sectionId' => $selectedSectionId
            ]);

$__html = app('livewire')->mount($__name, $__params, 'timetable-view-' . $selectedTimetableRecord . '-' . $selectedSectionId, $__slots ?? [], get_defined_vars());
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/timetable-manager.blade.php ENDPATH**/ ?>