            ...
            <div class="bg-white rounded-lg overflow-hidden">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        <?php echo e($isEditing ? 'Edit Grading System' : 'Create New Grading System'); ?>

                    </h3>
                    <div class="mt-2 max-w-xl text-sm text-gray-500">
                        <p><?php echo e($isEditing ? 'Update the details of your grading system.' : 'Fill in the details to create a new grading system.'); ?></p>
                    </div>
                    
                    <form wire:submit="<?php echo e($isEditing ? 'update' : 'store'); ?>" class="mt-5 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['effective_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="sm:col-span-3 space-y-6">
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['rules'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center" wire:key="subject-<?php echo e($subject->id); ?>">
                                                <input type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                                    ...
                                                    checked
                                            disabled>
                                                <label for="subject-<?php echo e($subject->id); ?>" class="ml-2 block text-sm text-gray-700 truncate">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedSubjects'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <!-- Form Buttons -->
                        <div class="sm:col-span-6 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                ...
                                <span wire:loading wire:target="<?php echo e($isEditing ? 'update' : 'store'); ?>" class="ml-2">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $gradingSystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gradingSystem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <?php echo nl2br(e($gradingSystem->description)); ?>

                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($gradingSystem->effective_date)->format('M d, Y')); ?>

                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <div class="flex flex-wrap gap-1">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $gradingSystem->subjects->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($subject->subject_name); ?>

                                </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($gradingSystem->subjects->count() > 5): ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                                                +<?php echo e($gradingSystem->subjects->count() - 5); ?> more
                                            </span>
                                ...
                                <td class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                    <div class="flex space-x-2">
                                        <button wire:click="edit(<?php echo e($gradingSystem->id); ?>)" class="text-gray-400 hover:text-blue-500 transition-colors duration-200">
                                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                </button>
                                        <button 
                                            @click="deleteId = <?php echo e($gradingSystem->id); ?>; showConfirmDelete = true" 
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/grading-management.blade.php ENDPATH**/ ?>