...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <!--[if BLOCK]><![endif]--><?php if($selectedClass): ?>
            ...
            <div>
                ...
                <select wire:model.live="selectedYear" id="year" 
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = range(date('Y') - 5, date('Y')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- Applied Filters -->
    <!--[if BLOCK]><![endif]--><?php if($selectedClass || !empty($selectedExams)): ?>
        <div class="mt-4 flex flex-wrap items-center gap-2">
            <!--[if BLOCK]><![endif]--><?php if($selectedClass): ?>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#E2EFDA] text-[#217346]">
                    Class: <?php echo e(optional($classes->firstWhere('id', $selectedClass))->name); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($selectedTerm): ?>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#E2EFDA] text-[#217346]">
                    Term: <?php echo e($selectedTerm); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($selectedYear): ?>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#E2EFDA] text-[#217346]">
                    Year: <?php echo e($selectedYear); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/combination-formula/_filters.blade.php ENDPATH**/ ?>