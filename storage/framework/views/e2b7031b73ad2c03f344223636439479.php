<!--[if BLOCK]><![endif]--><?php if($selectedClass && $selectedExam && $selectedSubject): ?>
        ...
        <div class="bg-gradient-to-r from-purple-600 to-indigo-700 px-6 py-4 rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($selectedClassName): ?>
                        <div class="mt-2">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($selectedClassName); ?>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div wire:key="section-<?php echo e($section->id); ?>" 
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center">
                                            <span class="text-sm font-medium text-purple-600"><?php echo e(substr($section->name ?? 'S', 0, 2)); ?></span>
                                        </div>
                                    </div>
                                    <div>
                                        <h3 class="text-sm font-medium text-gray-900"><?php echo e($section->name ?? 'Unknown Section'); ?></h3>
                                        <div class="flex items-center mt-1 space-x-2">
                                            <span class="text-xs text-gray-500">
                                                <?php echo e($section->students_count ?? 0); ?> Students
                                            </span>
                                            <!--[if BLOCK]><![endif]--><?php if(isset($section->enrolled_count)): ?>
                                                <span class="text-xs px-1.5 py-0.5 rounded-full <?php echo e($section->enrolled_count > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    <?php echo e($section->enrolled_count); ?> Enrolled
                                                </span>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                    </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-purple-700">
                                    <?php echo e($sections->where('id', $selectedSection)->first()->name ?? 'Selected Stream'); ?>

                                    <!--[if BLOCK]><![endif]--><?php if($selectedClassName): ?>
                                        <span class="text-purple-500">•</span>
                                        <span class="text-purple-700"><?php echo e($selectedClassName); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/exam-marks/streams.blade.php ENDPATH**/ ?>