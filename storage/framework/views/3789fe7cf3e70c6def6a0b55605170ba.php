...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="sm:col-span-3">
        ...
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['isbn13'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="sm:col-span-6">
        ...
        <div class="mt-1 flex items-center space-x-4">
            <!--[if BLOCK]><![endif]--><?php if($existing_cover_image): ?>
                <div class="flex-shrink-0 h-32 w-24 bg-gray-100 rounded-md overflow-hidden">
                    <img src="<?php echo e(Storage::url($existing_cover_image)); ?>" alt="Cover" class="h-full w-full object-cover">
                </div>
            <?php elseif($newCoverImage): ?>
                <div class="flex-shrink-0 h-32 w-24 bg-gray-100 rounded-md overflow-hidden">
                    <img src="<?php echo e($newCoverImage->temporaryUrl()); ?>" alt="Temp Cover" class="h-full w-full object-cover">
                </div>
            <?php else: ?>
            ...
            <div>
                <label for="cover_image_input" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 cursor-pointer">
                    ...
                    <?php echo e($existing_cover_image || $newCoverImage ? 'Change Cover' : 'Upload Cover'); ?>

                </label>
                <input id="cover_image_input" wire:model="newCoverImage" type="file" class="sr-only" accept="image/*">
                
                <!--[if BLOCK]><![endif]--><?php if($existing_cover_image || $newCoverImage): ?>
                    <button 
                        type="button"
        ...
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newCoverImage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/partials/library/books/form-basic.blade.php ENDPATH**/ ?>