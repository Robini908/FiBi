...
<div 
    ...
    x-show="show"
    <?php if($sticky): ?>
    class="fixed z-50 <?php echo e($positionClass); ?>"
    <?php else: ?>
    class="<?php echo e($currentType['wrapper']); ?>"
    <?php endif; ?>
...
>
    <?php if($sticky): ?>
    <div class="<?php echo e($currentType['wrapper']); ?> shadow">
    <?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center flex-1 min-w-0">
                <?php if($iconHtml): ?>
                    <span class="<?php echo e($currentType['icon']); ?> mr-3">
                        <?php echo $iconHtml; ?>

                    </span>
                <?php endif; ?>
                <div class="min-w-0 flex-1 <?php echo e($currentType['container']); ?>">
                    <?php if($title): ?>
                        <p class="text-sm font-medium <?php echo e($currentType['title']); ?>">
                            <?php echo e($title); ?>

                        </p>
                    <?php endif; ?>
                    
                    <p class="text-sm <?php if($title): ?> mt-1 <?php endif; ?>">
                        <?php echo e($slot); ?>
            ...
            <div class="flex-shrink-0 flex items-center mt-3 sm:mt-0 sm:ml-3">
                <?php if($action && $actionText): ?>
                    <a href="<?php echo e($actionUrl); ?>" class="rounded-md px-3 py-1.5 text-sm font-medium <?php echo e($currentType['action']); ?>">
                        <?php echo e($actionText); ?>

                    </a>
                <?php endif; ?>
                
                <?php if($dismissible && $showClose): ?>
                    <button 
                        type="button" 
                        @click="show = false"
                        class="ml-3 flex-shrink-0 <?php echo e($currentType['close']); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
    ...
    <?php endif; ?>
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/components/ui/banner.blade.php ENDPATH**/ ?>