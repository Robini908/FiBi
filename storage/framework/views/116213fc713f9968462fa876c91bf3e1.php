<!--[if BLOCK]><![endif]--><?php if($showGradingSystemDetailsModal): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($selectedGradingSystem): ?>
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                                <div>
                                    ...
                                    <span class="block mt-1 text-sm text-gray-900"><?php echo e($selectedGradingSystem->name); ?></span>
                                </div>
                                <div>
                                    <span class="block text-sm font-medium text-gray-500">Effective Date</span>
                                    <span class="block mt-1 text-sm text-gray-900">
                                        <?php echo e(\Carbon\Carbon::parse($selectedGradingSystem->effective_date)->format('d M, Y')); ?>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <span class="block mt-1 text-sm text-gray-900">
                                        <?php echo e($selectedGradingSystem->description ?: 'No description provided'); ?>
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(isset($selectedGradingSystem->gradingRanges) && $selectedGradingSystem->gradingRanges->count() > 0): ?>
                                <div class="overflow-x-auto mt-2 rounded-lg border border-gray-200">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedGradingSystem->gradingRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-3 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($range->grade); ?></td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e($range->min_score); ?></td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e($range->max_score); ?></td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e($range->remark); ?></td>
                                                <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500">
                                                    <!--[if BLOCK]><![endif]--><?php if($range->subject): ?>
                                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                            <?php echo e($range->subject->subject_name); ?>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span class="block mt-1 text-sm text-gray-900"><?php echo e($selectedGradingSystem->created_at->format('d M, Y H:i A')); ?></span>
                                </div>
                                <div>
                                    <span class="block text-sm font-medium text-gray-500">Last Updated</span>
                                    <span class="block mt-1 text-sm text-gray-900"><?php echo e($selectedGradingSystem->updated_at->format('d M, Y H:i A')); ?></span>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($selectedGradingSystem->created_by): ?>
                                <div>
                                    ...
                                    <span class="block mt-1 text-sm text-gray-900">
                                        ...
                                        ?>
                                        <?php echo e($creator ? $creator->name : 'Unknown User'); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\projects\MbukuErp\resources\views/livewire/exams/partials/modals/grading-system-details.blade.php ENDPATH**/ ?>