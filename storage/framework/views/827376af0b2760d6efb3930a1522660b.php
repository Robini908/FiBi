<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    ...
    <div x-data="{ 
        ...
        <!-- Filter Bar -->
        <?php echo $__env->make('livewire.timetable.partials.exam-timetable-filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
        <!-- Tab Content -->
        <div class="p-6">
            <!-- Timetable Tab Content -->
            <div x-show="activeTab === 'timetable'">
                <?php echo $__env->make('livewire.timetable.partials.exam-timetable-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            
            <!-- Export Tab Content -->
            <div x-show="activeTab === 'export'">
                <?php echo $__env->make('livewire.timetable.partials.exam-timetable-export', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        
        <!-- Settings Modal -->
        <div x-show="showSettings" class="fixed inset-0 overflow-y-auto z-50" x-cloak>
            <?php echo $__env->make('livewire.timetable.partials.exam-timetable-settings-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        
        <!-- Generation Settings Modal -->
        <div x-show="showGeneration" class="fixed inset-0 overflow-y-auto z-50" x-cloak>
            <?php echo $__env->make('livewire.timetable.partials.exam-timetable-generation-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        
        <!-- Schedule Form Modal -->
        <div x-show="$wire.showScheduleForm" class="fixed inset-0 overflow-y-auto z-50" x-cloak>
            <?php echo $__env->make('livewire.timetable.partials.exam-timetable-schedule-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/exam-timetable.blade.php ENDPATH**/ ?>