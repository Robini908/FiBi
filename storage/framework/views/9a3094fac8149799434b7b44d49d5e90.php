...
<div class="bg-white dark:bg-gray-50 rounded-lg shadow-sm overflow-hidden" x-data="{ 
    occupancyData: <?php echo \Illuminate\Support\Js::from($occupancyData)->toHtml() ?>,
    init() {
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-200 bg-gray-50 dark:bg-gray-100 flex justify-between items-center">
        <h2 class="font-medium text-xl text-gray-800 dark:text-gray-800 flex items-center">
            ...
            Occupancy Over the Years - <?php echo e($dormName); ?>
    ...
    <!-- Key Stats Summary -->
    <!--[if BLOCK]><![endif]--><?php if(count($occupancyData) > 0): ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-200">
                    ...
                    <tbody class="bg-white dark:bg-white divide-y divide-gray-200 dark:divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $occupancyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-50 transition-colors duration-150 ease-in-out">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-800"><?php echo e($data->year); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button 
                                        wire:click="viewStudents('<?php echo e($data->year); ?>')" 
                                    ...
                                    >
                                        <span class="font-medium"><?php echo e($data->occupancy); ?></span>
                                        <span class="text-gray-500 dark:text-gray-500 mx-1">/</span>
                                        <span><?php echo e($dormCapacity); ?></span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-full bg-gray-200 dark:bg-gray-200 rounded-full h-2.5 mr-2 max-w-[150px]">
                                            <div class="<?php echo e($progressColor); ?> h-2.5 rounded-full" style="width: <?php echo e($occupancyPercentage); ?>%"></div>
                                        </div>
                                        <span class="text-sm font-medium <?php echo e($textColor); ?>"><?php echo e(round($occupancyPercentage, 1)); ?>%</span>
                                    </div>
                                </td>
                            </tr>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/dorms/occupancy-card.blade.php ENDPATH**/ ?>