...
<div class="bg-white dark:bg-gray-50 rounded-lg shadow-sm overflow-hidden" 
     x-data="{ 
        isFormValid: false,
        name: <?php if ((object) ('name') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('name'->value()); ?>')<?php echo e('name'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('name'); ?>')<?php endif; ?>.defer,
        capacity: <?php if ((object) ('capacity') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('capacity'->value()); ?>')<?php echo e('capacity'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('capacity'); ?>')<?php endif; ?>.defer,
        description: <?php if ((object) ('description') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('description'->value()); ?>')<?php echo e('description'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('description'); ?>')<?php endif; ?>.defer,
        validate() {
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-200 bg-gray-50 dark:bg-gray-100 flex justify-between items-center">
        <h2 class="font-medium text-xl text-gray-800 dark:text-gray-800 flex items-center">
            ...
            <?php echo e($isEditing ? 'Edit Dormitory' : 'Create New Dormitory'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="pt-5 border-t border-gray-200 dark:border-gray-200 flex justify-end space-x-3">
            ...
            >
                ...
                <?php echo e($isEditing ? 'Update Dormitory' : 'Save Dormitory'); ?>

            </button>
        </div>
    </form>
</div>
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/dorms/create-edit-form.blade.php ENDPATH**/ ?>