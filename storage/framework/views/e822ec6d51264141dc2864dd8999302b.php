                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($deletingFeeStructure): ?>
                                <span class="font-medium text-red-600 block mt-2">Deleting: <?php echo e($deletingFeeStructure->fee_name); ?> (<?php echo e($deletingFeeStructure->year); ?> Term <?php echo e($deletingFeeStructure->term); ?>)</span>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1">
                        <textarea 
                            ...
                            rows="3" 
                            class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['deleteReason'];
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['deleteReason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/fee-structure-delete-modal.blade.php ENDPATH**/ ?>