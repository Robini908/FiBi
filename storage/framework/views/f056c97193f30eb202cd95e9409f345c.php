    ...
    <!--[if BLOCK]><![endif]--><?php if($classId && $sectionId): ?>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($overviewData['stats']['total_days'] ?? 0); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($overviewData['student_count'] ?? 0); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($overviewData['stats']['attendance_rate'] ?? 0); ?>%</div>
                                    <div class="ml-2 flex items-baseline text-sm font-semibold">
                                        <?php if(isset($overviewData['stats']['attendance_rate'])): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($overviewData['stats']['attendance_rate'] >= 95): ?>
                                                <span class="text-green-600">Excellent</span>
                                            <?php elseif($overviewData['stats']['attendance_rate'] >= 85): ?>
                                                <span class="text-green-600">Good</span>
                                            <?php elseif($overviewData['stats']['attendance_rate'] >= 75): ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($perfectAttendanceCount ?? 0); ?></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="p-4">
                    <div class="h-64">
                        <!--[if BLOCK]><![endif]--><?php if(method_exists($this, 'getOverviewChartModel')): ?>
                        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('livewire-pie-chart', ['pieChartModel' => $this->getOverviewChartModel()]);

$__html = app('livewire')->mount($__name, $__params, 'overview_pie', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="p-4">
                    <div class="h-64">
                        <!--[if BLOCK]><![endif]--><?php if(method_exists($this, 'getDayOfWeekChartModel') && isset($overviewData['day_of_week_stats'])): ?>
                        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('livewire-column-chart', ['columnChartModel' => $this->getDayOfWeekChartModel()]);

$__html = app('livewire')->mount($__name, $__params, 'day_of_week_chart', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topStudents ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8">
                                            <img class="h-8 w-8 rounded-full object-cover" src="<?php echo e($student['photo'] ?? asset('global_assets/images/user.png')); ?>" alt="<?php echo e($student['name'] ?? 'Student'); ?>">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($student['name'] ?? 'N/A'); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($student['adm_no'] ?? $student['admission_number'] ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($student['present_days'] ?? 0); ?>/<?php echo e($student['total_days'] ?? 0); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                        <?php echo e($student['attendance_rate'] ?? 0); ?>%
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <a href="<?php echo e(route('attendance.student.history', $student['id'] ?? 0)); ?>" class="text-green-600 hover:text-green-900">View</a>
                                </td>
                            </tr>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/attendance/partials/analytics-overview.blade.php ENDPATH**/ ?>