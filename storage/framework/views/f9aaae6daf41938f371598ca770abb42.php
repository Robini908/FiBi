<div class="mb-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div class="mb-4 sm:mb-0">
            <h1 class="text-xl sm:text-2xl font-normal text-gray-800"><?php echo e(__('School Settings')); ?></h1>
            <p class="text-sm text-gray-500 mt-1"><?php echo e(__('Manage your school configuration and preferences')); ?></p>
        </div>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/settings/header.blade.php ENDPATH**/ ?>