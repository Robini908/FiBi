<div class="min-w-full">
    <!--[if BLOCK]><![endif]--><?php if(empty($consolidatedData['consolidatedMatrix'])): ?>
        <div class="p-6 text-center text-gray-500">
            No class data available for the selected timetables.
        </div>
    <?php else: ?>
        <div class="bg-white">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $consolidatedData['consolidatedMatrix']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classId => $classData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <!--[if BLOCK]><![endif]--><?php if($loop->first): ?>
                                        <td rowspan="<?php echo e(count($consolidatedData['periods'])); ?>" class="px-3 py-4 whitespace-nowrap text-sm font-medium text-gray-900 align-top border-r">
                                            <div class="font-bold"><?php echo e($classData['class']->name); ?></div>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/partials/consolidated-class-view.blade.php ENDPATH**/ ?>