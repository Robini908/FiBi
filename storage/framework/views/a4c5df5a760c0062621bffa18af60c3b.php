<div
    x-data="{ open: $wire.entangle('showDeleteModal') }"
    x-show="open"
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            Are you sure you want to delete this fee allocation? This action cannot be undone.
                            All data related to this allocation will be permanently removed.
                        </p>
                    </div>
                </div>
            </div>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/allocation-delete-modal.blade.php ENDPATH**/ ?>