<div class="bg-gray-50 min-h-screen py-6">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($allocations->total()); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($pendingCount ?? 0); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900"><?php echo e($approvedCount ?? 0); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">KES <?php echo e(number_format($totalAmount ?? 0, 2)); ?></div>
                                </dd>
                            </dl>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="border-b border-gray-100 p-6">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($search || $financeAccountFilter || $statusFilter !== '' || $yearFilter || $termFilter): ?>
                        <button 
                ...
                <!--[if BLOCK]><![endif]--><?php if($search || $financeAccountFilter || $statusFilter !== '' || $yearFilter || $termFilter): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($financeAccountFilter): ?>
                            ...
                            <span>Account: <?php echo e($financeAccounts->where('id', $financeAccountFilter)->first()->name ?? 'Unknown'); ?></span>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($statusFilter !== ''): ?>
                            ...
                            <span>Status: <?php echo e($statusFilter == '1' ? 'Approved' : 'Pending'); ?></span>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($yearFilter): ?>
                            <span class="inline-flex items-center rounded-full bg-amber-50 px-3 py-1 text-sm font-medium text-amber-700 ring-1 ring-inset ring-amber-600/20">
                                <span>Year: <?php echo e($yearFilter); ?></span>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($termFilter): ?>
                            <span class="inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-sm font-medium text-indigo-700 ring-1 ring-inset ring-indigo-600/20">
                                <span>Term: <?php echo e($termFilter); ?></span>
            ...
            <!-- Allocations Table -->
            <div>
                <!--[if BLOCK]><![endif]--><?php if(count($allocations) > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allocation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150 ease-in-out">
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($allocation->financeAccount->name); ?>

                                            </div>
                                            <div class="text-sm text-gray-500">
                                                Balance: KES <?php echo e(number_format($allocation->financeAccount->current_balance, 2)); ?>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 font-medium"><?php echo e($allocation->votehead->name ?? 'Unknown'); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($allocation->votehead->category ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-medium text-gray-900">
                                                KES <?php echo e(number_format($allocation->amount, 2)); ?>

                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900">
                                                <?php echo e($allocation->academic_year); ?>

                                            </div>
                                            <div class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                Term <?php echo e($allocation->term); ?>

                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            <?php echo e($allocation->created_at->format('d M, Y')); ?>

                                        </td>
                                        <td class="px-6 py-4">
                                            <!--[if BLOCK]><![endif]--><?php if(!$allocation->is_approved): ?>
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium">
                                            <div class="flex space-x-3">
                                                <!--[if BLOCK]><![endif]--><?php if(!$allocation->is_approved): ?>
                                                    <button
                                                        wire:click="editAllocation(<?php echo e($allocation->id); ?>)"
                                                    ...
                                                    <button
                                                        wire:click="approveAllocation(<?php echo e($allocation->id); ?>)"
                                                    ...
                                                    <button
                                                        wire:click="confirmDeleteAllocation(<?php echo e($allocation->id); ?>)"
                                                ...
                                                <?php else: ?>
                                                    <button
                                                        wire:click="viewAllocation(<?php echo e($allocation->id); ?>)"
    ...
    <!-- Modals -->
    <?php echo $__env->make('livewire.finance.partials.allocation-form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('livewire.finance.partials.allocation-delete-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/fee-allocations.blade.php ENDPATH**/ ?>