<div
    x-data="{ modalOpen: <?php if ((object) ('showApproveModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showApproveModal'->value()); ?>')<?php echo e('showApproveModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showApproveModal'); ?>')<?php endif; ?>.live }"
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/payment-voucher-approve-modal.blade.php ENDPATH**/ ?>