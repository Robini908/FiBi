<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="px-5 py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">
                    <!--[if BLOCK]><![endif]--><?php if(isset($timeSlots) && $timeSlots && $timeSlots->count() > 0): ?>
                    <?php echo e($timeSlots->count()); ?> periods defined
                    <?php else: ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$cardMode): ?>
                            ...
                            x-data="{
                                ...
                                async copyToClipboard() {
                                    try {
                                        ...
                                        const data = await window.Livewire.find('<?php echo e($_instance->getId()); ?>').prepareClipboardData();
                                ...
                                toast(type, message) {
                                    ...
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('showToast', type, message);
                                }
                            }" 
    ...
    <!--[if BLOCK]><![endif]--><?php if($cardMode): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($showModal && ($activeCard === 'create' || $activeCard === 'edit')): ?>
            <div class="animate-fade-in m-4 bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-medium text-gray-800"><?php echo e($timeSlotForm['id'] ? 'Edit' : 'Create'); ?> Time Slot</h3>
            </div>
                ...
                <form wire:submit.prevent="saveTimeSlot" class="space-y-5">
                    ...
                    <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['timeSlotForm.start_time'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['timeSlotForm.end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                                <p class="mt-1 text-xs text-red-600"><?php echo e($message ?? 'Invalid end time format'); ?></p> 
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['timeSlotForm.period_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                            <p class="mt-1 text-xs text-red-600"><?php echo e($message ?? 'Invalid period name'); ?></p> 
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                        ...
                        <?php echo e($timeSlotForm['id'] ? 'Update' : 'Create'); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <!-- Auto Generate Card -->
        <!--[if BLOCK]><![endif]--><?php if($showAutoGenerateModal && $activeCard === 'auto-generate'): ?>
            <?php echo $__env->make('livewire.timetable.partials.time-slots-auto-generate-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        
        <!-- Delete Confirmation Card -->
        <!--[if BLOCK]><![endif]--><?php if($showDeleteModal && $activeCard === 'delete'): ?>
            <div class="animate-fade-in m-4 bg-white p-5 rounded-lg shadow-sm border border-gray-200">
    ...
    <?php else: ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($timeSlots->count() > 0): ?>
            <div class="px-5 py-4">
                ...
                <div class="mb-6">
                    <div class="flex items-center mb-3">
                        ...
                        <span class="ml-2 text-xs text-gray-500">(<?php echo e($weekdayTimeSlots->count()); ?> periods)</span>
                    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $weekdayTimeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition duration-150 <?php echo e($this->getPeriodBgClass($timeSlot->period_name)); ?>">
                                <td class="px-4 py-3 text-sm text-gray-900 max-w-[150px] truncate">
                                            <!--[if BLOCK]><![endif]--><?php if($timeSlot->period_name): ?>
                                                <span class="font-medium <?php echo e($this->getPeriodTextClass($timeSlot->period_name)); ?>"><?php echo e($timeSlot->period_name); ?></span>
                                            <?php else: ?>
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-600 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-3 h-3 <?php echo e($this->getPeriodIndicatorClass($timeSlot->period_name)); ?> rounded-full mr-1.5"></div>
                                                <?php echo e(date('h:i A', strtotime($timeSlot->start_time))); ?> - <?php echo e(date('h:i A', strtotime($timeSlot->end_time))); ?>
                                        ...
                                        <td class="hidden sm:table-cell px-4 py-3 text-sm text-gray-600 whitespace-nowrap">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($duration < 30 ? 'bg-gray-100 text-gray-800' : 'bg-green-100 text-green-800'); ?>">
                                                <?php echo e($duration); ?> mins
                                            </span>
                                        </td>
                                        <td class="hidden sm:table-cell px-4 py-3 text-sm text-gray-600 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($this->getPeriodBgClass($timeSlot->period_name)); ?> <?php echo e($this->getPeriodTextClass($timeSlot->period_name)); ?>">
                                                <?php echo e(ucfirst($this->getPeriodType($timeSlot->period_name))); ?>
                                        ...
                                        <td class="px-4 py-3 text-sm font-medium text-right whitespace-nowrap">
                                            ...
                                            <button 
                                                wire:click="editTimeSlot(<?php echo e($timeSlot->id); ?>)" 
                                            ...
                                            <button 
                                                    wire:click="confirmDelete(<?php echo e($timeSlot->id); ?>)" 
                ...
                <!--[if BLOCK]><![endif]--><?php if($hasWeekendSlots): ?>
                <div class="mb-6">
                    <div class="flex items-center mb-3">
                        ...
                        <span class="ml-2 text-xs text-gray-500">(<?php echo e($weekendTimeSlots->count()); ?> periods)</span>
                                        </div>
                    ...
                    <div class="overflow-x-auto bg-white rounded-lg border border-gray-200 shadow-sm">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $weekendTimeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($timeSlot->period_name): ?>
                                        <span class="font-medium"><?php echo e($timeSlot->period_name); ?></span>
                                    <?php else: ?>
                                        <span class="text-gray-500 italic">No Name</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                ...
                <!--[if BLOCK]><![endif]--><?php if($hasPrepSlots): ?>
                <div class="mb-6">
                    <div class="flex items-center mb-3">
                        ...
                        <span class="ml-2 text-xs text-gray-500">(<?php echo e($prepTimeSlots->count()); ?> periods)</span>
                                        </div>
                    ...
                    <div class="overflow-x-auto bg-white rounded-lg border border-gray-200 shadow-sm">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $prepTimeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSlot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/partials/time-slots.blade.php ENDPATH**/ ?>