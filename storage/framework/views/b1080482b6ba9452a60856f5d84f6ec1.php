...
<div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
    <div class="flex-1 relative">
        ...
        <input 
            ...
            x-on:keydown.enter="$wire.search ? null : $wire.resetFilters()"
        >
    </div>
    ...
    <div class="flex space-x-2">
        ...
        >
            <svg class="mr-1.5 h-4 w-4 text-gray-500" xmlns="http://www.w3.org/2000/svg"
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/students/search-filters.blade.php ENDPATH**/ ?>