<!--[if BLOCK]><![endif]--><?php if($selectedClass): ?>
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900"><?php echo e($classes->firstWhere('id', $selectedClass)?->name ?? 'Selected Class'); ?></h2>
                        <p class="text-sm text-gray-500">Select an exam to view analysis</p>
                    </div>
                </div>
                <div class="flex items-center">
                    <!--[if BLOCK]><![endif]--><?php if($exams->count() > 0): ?>
                        <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-[#E2EFDA] text-[#217346]">
                            <?php echo e($exams->count()); ?> Exams Available
                        </span>
        ...
        <!--[if BLOCK]><![endif]--><?php if($exams->isEmpty()): ?>
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div wire:key="exam-<?php echo e($exam->id); ?>" 
                        class="bg-white rounded-lg border transition-all duration-200 hover:shadow-md"
                        :class="{
                            'border-[#217346] ring-1 ring-[#217346]': $wire.selectedExam == <?php echo e($exam->id); ?>,
                            'border-gray-200': $wire.selectedExam != <?php echo e($exam->id); ?>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <?php echo e($exam->name ?? 'Unnamed Exam'); ?>
                                    ...
                                    <div class="flex items-center space-x-3 text-sm text-gray-500">
                                        <div class="flex items-center">
                                            ...
                                            <span>Term <?php echo e($exam->term ?? '-'); ?></span>
                                        </div>
                                        <span class="text-gray-300">|</span>
                                        <span>Year <?php echo e($exam->year ?? '-'); ?></span>
                                    </div>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($selectedExam == $exam->id): ?>
                            ...
                            <div class="mb-4 flex items-center justify-between bg-gray-50 rounded-lg p-3">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($exam->student_count ?? 0); ?> / <?php echo e($exam->myClass->total_students); ?></div>
                                ...
                                <div class="text-xs px-2 py-1 bg-[#E2EFDA] text-[#217346] rounded-full font-medium">
                                    <?php echo e($exam->turnout_percentage ?? 0); ?>% Turnout
                                </div>
                            </div>

                            <!-- Action Button -->
                            <button wire:click="selectExamForAnalysis(<?php echo e($exam->id); ?>)"
                                ...
                                :class="{ 'opacity-75': $wire.loading && $wire.selectedExam == <?php echo e($exam->id); ?> }"
                                wire:loading.attr="disabled">
                                <div class="px-4 py-2.5 flex items-center justify-center">
                                    <div wire:loading.remove wire:target="selectExamForAnalysis(<?php echo e($exam->id); ?>)">
                                        <span x-text="$wire.selectedExam == <?php echo e($exam->id); ?> ? 'Selected for Analysis' : 'Select for Analysis'"
                                            class="text-sm font-medium"></span>
                                    </div>
                                    <div wire:loading wire:target="selectExamForAnalysis(<?php echo e($exam->id); ?>)"
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/combination-formula/_exam-display.blade.php ENDPATH**/ ?>