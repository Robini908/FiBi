...
<div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
    ...
    <div class="p-6">
        <p class="text-sm text-gray-600 mb-4">Fill out the form below to record a payment for <span class="font-medium"><?php echo e($student_name); ?></span> for <span class="font-medium"><?php echo e($academic_year); ?></span>, Term <span class="font-medium"><?php echo e($term); ?></span>.</p>
            ...
            <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div 
                            ...
                            class="cursor-pointer p-3 rounded-lg border <?php echo e($payment_method === 'cash' ? 'bg-green-50 border-green-500 ring-1 ring-green-500' : 'border-gray-300 hover:border-green-400'); ?> transition-all duration-150 ease-in-out"
                        >
                            <div class="flex flex-col items-center justify-center">
                                <svg class="w-6 h-6 <?php echo e($payment_method === 'cash' ? 'text-green-600' : 'text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                                <span class="mt-2 text-sm font-medium <?php echo e($payment_method === 'cash' ? 'text-green-800' : 'text-gray-700'); ?>">Cash</span>
                            </div>
                        </div>

                        <div 
                            wire:click="$set('payment_method', 'cheque')" 
                            class="cursor-pointer p-3 rounded-lg border <?php echo e($payment_method === 'cheque' ? 'bg-green-50 border-green-500 ring-1 ring-green-500' : 'border-gray-300 hover:border-green-400'); ?> transition-all duration-150 ease-in-out"
                        >
                            <div class="flex flex-col items-center justify-center">
                                <svg class="w-6 h-6 <?php echo e($payment_method === 'cheque' ? 'text-green-600' : 'text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                <span class="mt-2 text-sm font-medium <?php echo e($payment_method === 'cheque' ? 'text-green-800' : 'text-gray-700'); ?>">Cheque</span>
                            </div>
                        </div>

                        <div 
                            wire:click="$set('payment_method', 'bank_transfer')" 
                            class="cursor-pointer p-3 rounded-lg border <?php echo e($payment_method === 'bank_transfer' ? 'bg-green-50 border-green-500 ring-1 ring-green-500' : 'border-gray-300 hover:border-green-400'); ?> transition-all duration-150 ease-in-out"
                        >
                            <div class="flex flex-col items-center justify-center">
                                <svg class="w-6 h-6 <?php echo e($payment_method === 'bank_transfer' ? 'text-green-600' : 'text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                                </svg>
                                <span class="mt-2 text-sm font-medium <?php echo e($payment_method === 'bank_transfer' ? 'text-green-800' : 'text-gray-700'); ?>">Bank Transfer</span>
                            </div>
                        </div>

                        <div 
                            wire:click="$set('payment_method', 'mpesa')" 
                            class="cursor-pointer p-3 rounded-lg border <?php echo e($payment_method === 'mpesa' ? 'bg-green-50 border-green-500 ring-1 ring-green-500' : 'border-gray-300 hover:border-green-400'); ?> transition-all duration-150 ease-in-out"
                        >
                            <div class="flex flex-col items-center justify-center">
                                <svg class="w-6 h-6 <?php echo e($payment_method === 'mpesa' ? 'text-green-600' : 'text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                </svg>
                                <span class="mt-2 text-sm font-medium <?php echo e($payment_method === 'mpesa' ? 'text-green-800' : 'text-gray-700'); ?>">M-Pesa</span>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                            ...
                            <input 
                                ...
                                required
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['cheque_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                            ...
                            <input 
                                ...
                                required
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['bank_slip_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                            ...
                            <input 
                                ...
                                wire:model="bank_branch"
                                    class="mt-1 block w-full py-2 sm:text-sm rounded-md border-gray-300 focus:ring-green-500 focus:border-green-500 shadow-sm"
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['bank_branch'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <?php elseif($payment_method === 'mpesa'): ?>
                    <div class="border-t border-gray-200 pt-4 mt-4">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                            ...
                            <input 
                                ...
                                required
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['mpesa_transaction_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                            ...
                            <input 
                                type="datetime-local" 
                                    ...
                                    required
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['mpesa_transaction_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <input 
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['receipt_attachment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($receipt_attachment): ?>
                                <p class="mt-2 text-sm text-green-600">File selected: <?php echo e($receipt_attachment->getClientOriginalName()); ?></p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/payment-form.blade.php ENDPATH**/ ?>