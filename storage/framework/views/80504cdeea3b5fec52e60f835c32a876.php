<div x-data="{
    ...
    showNewCategoryForm: <?php if ((object) ('showNewCategoryForm') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showNewCategoryForm'->value()); ?>')<?php echo e('showNewCategoryForm'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showNewCategoryForm'); ?>')<?php endif; ?>.live,
    ...
    <!--[if BLOCK]><![endif]--><?php if($showForm): ?>
        <!-- Subject Form -->
        <?php echo $__env->make('livewire.partials.subject-management.subject-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php else: ?>
        <!-- Subject List -->
        <?php echo $__env->make('livewire.partials.subject-management.subject-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/manage-subjectss.blade.php ENDPATH**/ ?>