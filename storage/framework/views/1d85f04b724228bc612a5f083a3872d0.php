...
<div class="bg-white dark:bg-gray-50 rounded-lg shadow-sm overflow-hidden" 
     x-data="{ 
        isFormValid: false,
        teacherId: <?php if ((object) ('teacherId') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('teacherId'->value()); ?>')<?php echo e('teacherId'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('teacherId'); ?>')<?php endif; ?>.defer,
...
unset($__errorArgs, $__bag); ?>" 
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['teacherId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/dorms/dorm-master.blade.php ENDPATH**/ ?>