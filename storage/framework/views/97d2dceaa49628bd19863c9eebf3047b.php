...
<<?php echo e($tag); ?> 
    <?php echo e($hrefAttr); ?> 
    <?php echo e($attributes->merge(['class' => 'inline-flex items-center ' . $sizes['container']])); ?>

>
    <?php if($mode !== 'text'): ?>
        <div class="flex-shrink-0 <?php echo e($colors['icon']); ?>">
            <svg class="<?php echo e($sizes['icon']); ?>" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <?php if($mode !== 'icon'): ?>
        <div class="<?php echo e($mode === 'full' ? $sizes['spacing'] : ''); ?> <?php echo e($colors['text']); ?> font-bold <?php echo e($sizes['text']); ?>">
            Mbuku School
        </div>
    <?php endif; ?>
</<?php echo e($tag); ?>> <?php /**PATH C:\projects\MbukuErp\resources\views/components/ui/app-logo.blade.php ENDPATH**/ ?>