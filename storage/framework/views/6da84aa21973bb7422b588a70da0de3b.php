...
<?php $__env->startSection('page_title', 'Edit Grading System'); ?>
...
<?php $__env->startSection('page_action_buttons'); ?>
    <a 
        ...
        x-data=""
        @click.prevent="$dispatch('navigate-to', {route: '<?php echo e(route('exams.grading-systems.index')); ?>'})"
    >
...
<?php $__env->startSection('content'); ?>
    <div 
        x-data="{
            ...
            errorMessage: '',
            gradingSystemId: '<?php echo e(request()->route('gradingSystem')); ?>'
        }"
        x-init="
            Livewire.on('gradingSystemUpdated', (message) => {
                ...
                setTimeout(() => {
                    window.history.pushState({}, '', '<?php echo e(route('exams.grading-systems.index')); ?>');
                    $dispatch('navigate-to', {route: '<?php echo e(route('exams.grading-systems.index')); ?>'});
                }, 1500);
            });
...
[$__name, $__params] = $__split('exams.edit-grading-system', ['gradingSystem' => request()->route('gradingSystem')]);

$__html = app('livewire')->mount($__name, $__params, 'lw-3060632781-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/exams/grading-systems/edit.blade.php ENDPATH**/ ?>