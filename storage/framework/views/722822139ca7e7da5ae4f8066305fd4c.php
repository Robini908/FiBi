                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['autoGenerateForm.lesson_duration'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="flex items-center p-2 bg-gray-50 rounded-lg">
                                ...
                                <label for="include_breaks" class="ml-2 block text-xs text-gray-700">
                                    Short breaks
                                    <!--[if BLOCK]><![endif]--><?php if(isset($autoGenerateForm['include_breaks']) && $autoGenerateForm['include_breaks']): ?>
                            ...
                            <div class="flex items-center p-2 bg-gray-50 rounded-lg">
                                ...
                                <label for="include_lunch" class="ml-2 block text-xs text-gray-700">
                                    Lunch break
                                    <!--[if BLOCK]><![endif]--><?php if(isset($autoGenerateForm['include_lunch']) && $autoGenerateForm['include_lunch']): ?>
                            ...
                            <div class="flex items-center p-2 bg-gray-50 rounded-lg">
                                ...
                                <label for="include_extracurricular" class="ml-2 block text-xs text-gray-700">
                                    Games & activities
                                    <!--[if BLOCK]><![endif]--><?php if(isset($autoGenerateForm['include_extracurricular']) && $autoGenerateForm['include_extracurricular']): ?>
                            ...
                            <div class="flex items-center p-2 bg-gray-50 rounded-lg">
                                ...
                                <label for="include_transitions" class="ml-2 block text-xs text-gray-700">
                                    Movement time
                                    <!--[if BLOCK]><![endif]--><?php if(isset($autoGenerateForm['include_transitions']) && $autoGenerateForm['include_transitions']): ?>
                                        <span class="inline-flex items-center ml-1 px-1.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            On
                                        </span>
                                    <?php else: ?>
            ...
            <div class="sm:col-span-7 space-y-4">
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div class="p-4">
                        <?php echo $__env->make('livewire.timetable.partials.time-slots-preview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div x-show="open" x-transition class="p-4 divide-y divide-gray-200">
                        <?php echo $__env->make('livewire.timetable.partials.time-slots-advanced-settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div x-show="open" x-transition class="p-4 divide-y divide-gray-200">
                        <?php echo $__env->make('livewire.timetable.partials.time-slots-extended-schedule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div x-show="open" x-transition class="p-4 bg-gradient-to-r from-blue-50 to-white">
                        <?php echo $__env->make('livewire.timetable.partials.time-slots-how-to-use', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/timetable/partials/time-slots-auto-generate-form.blade.php ENDPATH**/ ?>