<div class="bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-100">
        <!--[if BLOCK]><![endif]--><?php if($isParent): ?>
    ...
    <div class="p-6">
        <!--[if BLOCK]><![endif]--><?php if(!$isStudent && !$selectedStudentId): ?>
            <!--[if BLOCK]><![endif]--><?php if($isParent && count($students) === 0): ?>
                ...
                <div class="py-8 px-4 text-center bg-gray-50 rounded-lg border border-gray-100">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Return to Dashboard
                        </a>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($isParent || !$isStudent): ?>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 <?php echo e($selectedStudentId == $student['id'] ? 'bg-green-50' : ''); ?>">
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                    <?php echo e($student['name']); ?>

                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($student['class']); ?></td>
                                <!--[if BLOCK]><![endif]--><?php if($isParent || !$isStudent): ?>
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <button
                                            wire:click="selectStudent(<?php echo e($student['id']); ?>)"
                                            class="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-5 font-medium rounded-md <?php echo e($selectedStudentId == $student['id'] ? 'text-green-800 bg-green-100' : 'text-white bg-green-600 hover:bg-green-700'); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                        >
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                            </svg>
                                            <?php echo e($selectedStudentId == $student['id'] ? 'Selected' : 'Select'); ?>
        ...
        <?php elseif(($search || isset($classFilter)) && !$isParent): ?>
        ...
        <?php elseif(!$isStudent && !$selectedStudentId && !$isParent): ?>
            <div class="mt-6 text-center py-8">
                <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
</div><?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/payment-student-selector.blade.php ENDPATH**/ ?>