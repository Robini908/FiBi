...
<?php $__env->startSection('page_title', 'Pricing'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Pricing Section -->
    <?php echo $__env->make('outerpages.partials.pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="text-center">
                ...
                <div class="mt-8 flex justify-center">
                    <div class="inline-flex rounded-md shadow">
                        <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-green-700 bg-white hover:bg-gray-50">
                            Request a demo
                        </a>
                    </div>
                    <div class="ml-3 inline-flex">
                        <a href="<?php echo e(route('demo')); ?>" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-500 bg-opacity-60 hover:bg-opacity-70">
                            Book a Demo
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/outerpages/pricing.blade.php ENDPATH**/ ?>