<div wire:poll.5000ms="updateUnreadCount">
    <div class="space-y-1 max-h-60 overflow-y-auto">
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('messages.index')); ?>" class="block hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                <div class="flex items-start p-3 <?php echo e($message->read_at ? '' : 'bg-green-50 dark:bg-green-900/10'); ?>">
                    ...
                    <div class="flex-shrink-0">
                        <!--[if BLOCK]><![endif]--><?php if($message->sender->photo): ?>
                            <img src="<?php echo e($message->sender->photo); ?>" 
                                 alt="<?php echo e($message->sender->name); ?>" 
                                 class="h-10 w-10 rounded-full object-cover border border-gray-200 dark:border-gray-600" />
                        <?php else: ?>
                            <div class="flex items-center justify-center h-10 w-10 rounded-full <?php echo e($message->read_at ? 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300' : 'bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-200'); ?>">
                    ...
                    <div class="ml-3 flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100 flex items-center">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($message->created_at->diffInHours() < 24 && !$message->read_at): ?>
