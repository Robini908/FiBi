     ...
     x-data="{ 
        ...
        setupListeners() {
            window.addEventListener('setTimeout', (e) => {
                setTimeout(() => {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').cancelTyping();
                }, e.detail.duration);
            });
        }
     }"
...
>
    ...
    <div :class="{'translate-x-0': mobileSidebarOpen, '-translate-x-full': !mobileSidebarOpen}"
        ...
        <?php echo $__env->make('messages.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <div class="flex-1 flex flex-col w-0 overflow-hidden">
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="flex-1 flex flex-col min-w-0 bg-white">
                <!--[if BLOCK]><![endif]--><?php if($view == 'chat'): ?>
                    <div 
                        ...
                        class="h-full"
                    >
                        <?php echo $__env->make('messages.partials.chat-area', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                <?php else: ?>
                    <!-- Welcome/Empty State -->
            ...
            <div x-show="showUserInfo" 
                 ...
                 x-cloak>
                <!--[if BLOCK]><![endif]--><?php if($view == 'chat'): ?>
                    <?php echo $__env->make('messages.partials.user-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
    </div>
