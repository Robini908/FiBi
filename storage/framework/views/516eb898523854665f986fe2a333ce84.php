...
<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(session('impersonated_by')): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(Auth::check() && Qs::isAdministrator()): ?>
            ...
            >
                ...
                <div x-show="currentTab === 'search'">
                    ...
                    <div class="max-h-60 overflow-y-auto" id="search-results">
                        <!--[if BLOCK]><![endif]--><?php if($search && $users->count()): ?>
                            <ul class="py-1">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <button 
                                            wire:click="impersonate(<?php echo e($user->id); ?>)" 
                                            wire:loading.attr="disabled"
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 overflow-hidden">
                                                    <!--[if BLOCK]><![endif]--><?php if($user->photo): ?>
                                                        <img src="<?php echo e(asset($user->photo)); ?>" alt="<?php echo e($user->name); ?>" class="h-10 w-10 rounded-full object-cover">
                                                    <?php else: ?>
                ...
                <div x-show="currentTab === 'recent'" class="max-h-60 overflow-y-auto">
                    <!--[if BLOCK]><![endif]--><?php if(count($recentlyImpersonated) > 0): ?>
                        <ul class="py-1">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentlyImpersonated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <button 
                                        wire:click="impersonate(<?php echo e($recentUser['id']); ?>)" 
                                        wire:loading.attr="disabled"
                                        class="w-full px-4 py-2 text-left hover:bg-gray-50 transition-colors duration-150 flex items-center space-x-3"
                                    >
                                        <!-- User Avatar -->
                                        <div class="flex-shrink-0">
                                            <div class="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 overflow-hidden">
                                                <!--[if BLOCK]><![endif]--><?php if(isset($recentUser['photo']) && $recentUser['photo']): ?>
                                                    <img src="<?php echo e(asset($recentUser['photo'])); ?>" alt="<?php echo e($recentUser['name']); ?>" class="h-10 w-10 rounded-full object-cover">
                                                <?php else: ?>
                                                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
                                                    </svg>
                                        ...
                                        <!-- User Info -->
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($recentUser['name']); ?></p>
                                            <p class="text-xs text-gray-500 truncate"><?php echo e($recentUser['email']); ?></p>
                                        </div>
                                        
                                        <!-- User Role Badge -->
                                        <div class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-50 text-gray-800">
                                            <?php echo e($recentUser['role'] ?? 'User'); ?>
...
</div><?php /**PATH C:\projects\MbukuErp\resources\views/livewire/impersonate-user.blade.php ENDPATH**/ ?>