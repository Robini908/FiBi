<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6" x-data="{ localTransitionType: <?php if ((object) ('transitionType') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('transitionType'->value()); ?>')<?php echo e('transitionType'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('transitionType'); ?>')<?php endif; ?> }">
    ...
    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['transitionType'];
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/promote-students/transition-type-selector.blade.php ENDPATH**/ ?>