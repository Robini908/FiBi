    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div 
            ...
            <div>
                ...
                <div class="flex items-start justify-between pb-3 border-b border-gray-200">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">
                            <?php echo e($feeStructureId ? 'Edit Fee Structure' : 'Add New Fee Structure'); ?>

                        </h3>
                        <p class="mt-1 text-sm text-gray-500">
                            <?php echo e($feeStructureId ? 'Update this fee structure details' : 'Fill in the form to create a new fee structure'); ?>
                ...
                <!-- Form content -->
                <form wire:submit.prevent="<?php echo e($feeStructureId ? 'updateFeeStructure' : 'saveFeeStructure'); ?>">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <input 
                                    ...
                                    id="fee_name" 
                                    wire:model="fee_name" 
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['fee_name'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fee_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input 
                                    ...
                                    step="0.01"
                                    min="0"
                                    class="pl-12 focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <select 
                                    id="category" 
                                    wire:model="category" 
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <select 
                                    ...
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['classroom_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['classroom_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <select 
                                    id="year" 
                                    wire:model="year" 
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <select 
                                    id="term" 
                                    wire:model="term" 
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['term'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="mt-1">
                                <textarea 
                                    ...
                                    rows="3" 
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200 flex justify-end">
                        ...
                        <button 
                            ...
                            <?php echo e($feeStructureId ? 'Update Fee' : 'Save Fee'); ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/finance/partials/fee-structure-form-modal.blade.php ENDPATH**/ ?>