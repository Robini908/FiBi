            ...
            <!--[if BLOCK]><![endif]--><?php if($student): ?>
                <div class="mt-1 flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                        <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e($student->user->photo ?? asset('global_assets/images/user.png')); ?>" alt="<?php echo e($student->name); ?>">
                    </div>
                    <div class="ml-3">
                        <div class="text-sm font-medium text-gray-900"><?php echo e($student->name); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($student->adm_no); ?> | <?php echo e($student->my_class->name); ?> <?php echo e($student->section->name); ?></div>
                    </div>
                </div>
            <?php else: ?>
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="student-selector" wire:model.live="studentId" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-md" <?php echo e(count($students) > 0 ? '' : 'disabled'); ?>>
                                <option value="">-- Select Student --</option>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($studentOption->id); ?>"><?php echo e($studentOption->name); ?> (<?php echo e($studentOption->adm_no); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(count($students) === 0 && $selectedClassId): ?>
...
<div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 gap-y-4 gap-x-4 md:grid-cols-2">
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button type="button" wire:click="setTermFilter('current')" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded <?php echo e($termFilter === 'current' ? 'bg-green-100 border-green-300 text-green-800' : 'bg-white text-gray-700 hover:bg-gray-50'); ?> focus:outline-none focus:ring-1 focus:ring-green-500">
                            Current Term
                        </button>
                        <button type="button" wire:click="setTermFilter('term1')" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded <?php echo e($termFilter === 'term1' ? 'bg-green-100 border-green-300 text-green-800' : 'bg-white text-gray-700 hover:bg-gray-50'); ?> focus:outline-none focus:ring-1 focus:ring-green-500">
                            Term 1
                        </button>
                        <button type="button" wire:click="setTermFilter('term2')" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded <?php echo e($termFilter === 'term2' ? 'bg-green-100 border-green-300 text-green-800' : 'bg-white text-gray-700 hover:bg-gray-50'); ?> focus:outline-none focus:ring-1 focus:ring-green-500">
                            Term 2
                        </button>
                        <button type="button" wire:click="setTermFilter('term3')" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded <?php echo e($termFilter === 'term3' ? 'bg-green-100 border-green-300 text-green-800' : 'bg-white text-gray-700 hover:bg-gray-50'); ?> focus:outline-none focus:ring-1 focus:ring-green-500">
                            Term 3
                        </button>
                        <button type="button" wire:click="setTermFilter('academic_year')" class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded <?php echo e($termFilter === 'academic_year' ? 'bg-green-100 border-green-300 text-green-800' : 'bg-white text-gray-700 hover:bg-gray-50'); ?> focus:outline-none focus:ring-1 focus:ring-green-500">
                            Academic Year
                        </button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="relative flex-grow">
                            <input type="text" id="student-date-range" placeholder="Select date range" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($startDate); ?> to <?php echo e($endDate); ?>">
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/attendance/partials/student-header.blade.php ENDPATH**/ ?>