<div x-data="{ filtersOpen: false }" class="relative mb-6">
    ...
    >
        <!--[if BLOCK]><![endif]--><?php if(!empty($search) || !empty($selectedCategories) || $onlyAvailable || $onlyFeatured): ?>
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                <?php echo e((!empty($search) ? 1 : 0) + 
                   (!empty($selectedCategories) ? 1 : 0) + 
                   ($onlyAvailable ? 1 : 0) + 
                   ($onlyFeatured ? 1 : 0)); ?> active
            </span>
        ...
        <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                ...
                <div class="md:col-span-5">
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                            <button wire:click="$set('search', '')" type="button" class="<?php echo e(empty($search) ? 'hidden' : 'block'); ?> text-gray-400 hover:text-gray-500">
                ...
                <div class="md:col-span-4">
                    <select wire:model="selectedCategories" id="category-filter" multiple
                ...
                <div class="md:col-span-3">
                    <div class="flex">
                        <select wire:model="sortField" id="sort-order"
                            ...
                            <option value="copies_available">Available Copies</option>
                        </select>
            ...
            <div class="flex flex-wrap -mx-1">
                <div class="px-1 w-1/2 sm:w-1/4">
                    <label class="flex items-center justify-between px-3 py-2 rounded-md border border-gray-200 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors duration-200 w-full">
                        <span class="text-xs font-medium text-gray-700">Available Only</span>
                        <input wire:model="onlyAvailable" id="only-available" type="checkbox" 
                ...
                <div class="px-1 w-1/2 sm:w-1/4">
                    <label class="flex items-center justify-between px-3 py-2 rounded-md border border-gray-200 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors duration-200 w-full">
                        ...
                        <input wire:model="onlyFeatured" id="only-featured" type="checkbox" 
                            class="h-4 w-4 text-green-600 focus:ring-green-500 focus:ring-opacity-25 border-gray-300 rounded">
                    </label>
                </div>
            </div>
            ...
            <div class="flex flex-wrap items-center pt-2">
                ...
                <span class="mr-1 mb-1 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    <?php echo e(Str::limit($search, 15)); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!empty($selectedCategories)): ?>
                <span class="mr-1 mb-1 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    <?php echo e(count($selectedCategories)); ?> <?php echo e(Str::plural('category', count($selectedCategories))); ?>

                    <button wire:click="$set('selectedCategories', [])" class="ml-1 flex-shrink-0 inline-flex text-blue-500 focus:outline-none">
                        <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
                        </svg>
                    </button>
                ...
                <!--[if BLOCK]><![endif]--><?php if($onlyAvailable): ?>
                <span class="mr-1 mb-1 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                    Available
                    <button wire:click="$set('onlyAvailable', false)" class="ml-1 flex-shrink-0 inline-flex text-yellow-500 focus:outline-none">
                        <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
                        </svg>
                    </button>
                ...
                <!--[if BLOCK]><![endif]--><?php if($onlyFeatured): ?>
                <span class="mr-1 mb-1 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                    Featured
                    <button wire:click="$set('onlyFeatured', false)" class="ml-1 flex-shrink-0 inline-flex text-purple-500 focus:outline-none">
                        <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
                        </svg>
                    </button>
...
</style> <?php /**PATH C:\projects\MbukuErp\resources\views/partials/library/books/filters.blade.php ENDPATH**/ ?>