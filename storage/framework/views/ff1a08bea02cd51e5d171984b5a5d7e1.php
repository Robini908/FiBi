...
<div x-data="{ activeStep: 1, totalSteps: 4, isSubmitting: false, showSummary: true, transitionSuccess: false }" class="bg-white rounded-lg shadow-md">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    ...
                    <div class="flex items-center" x-show="activeStep >= 2">
                        ...
                        <div>
                            ...
                            <span class="font-medium ml-1 text-gray-800">
                                <!--[if BLOCK]><![endif]--><?php if($selectedClass && $selectedSection): ?>
                                    <?php echo e(optional($classes->firstWhere('id', $selectedClass))->name); ?> - 
                                    <?php echo e(optional($sections->firstWhere('id', $selectedSection))->name); ?>
                    ...
                    <div class="flex items-center" x-show="activeStep >= 3">
                        ...
                        <div>
                            ...
                            <span class="font-medium ml-1 text-gray-800">
                                <?php echo e(count($selectedStudents)); ?> selected
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <form wire:submit.prevent="promoteStudents" @submit="isSubmitting = true" class="px-6 py-4">
        ...
        <div x-show.transition.opacity.duration.500ms="activeStep === 1" 
            ...
            <?php echo $__env->make('livewire.partials.promote-students.transition-type-selector', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div x-show.transition.opacity.duration.500ms="activeStep === 2"
             ...
             x-transition:leave-end="opacity-0 transform -translate-x-4"
             class="max-w-4xl mx-auto">
            <?php echo $__env->make('livewire.partials.promote-students.class-section-selector', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div x-show.transition.opacity.duration.500ms="activeStep === 3"
            ...
            <?php echo $__env->make('livewire.partials.promote-students.student-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div x-show.transition.opacity.duration.500ms="activeStep === 4"
             ...
             x-transition:leave-end="opacity-0 transform -translate-x-4"
             class="max-w-4xl mx-auto">
            <?php echo $__env->make('livewire.partials.promote-students.transition-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</style><?php /**PATH C:\projects\MbukuErp\resources\views/livewire/promote-students.blade.php ENDPATH**/ ?>