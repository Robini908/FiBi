...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="p-4 border-b border-gray-200">
        <div class="flex items-center justify-between mb-2">
            <span class="text-sm font-medium text-gray-700">Total Percentage: <?php echo e($totalPercentage); ?>%</span>
            <span class="text-sm font-medium <?php echo e($totalPercentage > 100 ? 'text-red-600' : 'text-gray-500'); ?>">
                <?php echo e($totalPercentage > 100 ? 'Exceeds 100%' : ($totalPercentage < 100 ? 'Remaining: ' . (100 - $totalPercentage) . '%' : 'Perfect!')); ?>

            </span>
        </div>
        <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
            <div class="<?php echo e($progressColor); ?> h-2 transition-all duration-300 ease-in-out"
                style="width: <?php echo e(min($totalPercentage, 100)); ?>%">
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="relative rounded-md shadow-sm max-w-[150px]">
                                <input type="number"
                                    wire:model.live="examPercentages.<?php echo e($exam->id); ?>"
                                    <?php echo e(!in_array($exam->id, $this->selectedExams ?? []) ? 'disabled' : ''); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($exam->year); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">Term <?php echo e($exam->term); ?></div>
                        </td>
                    </tr>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!empty($selectedExams)): ?>
        <div class="p-4 bg-gray-50 border-t border-gray-200">
            <h4 class="text-sm font-medium text-gray-700 mb-2">Selected Exams:</h4>
            <div class="flex flex-wrap gap-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $examId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $exam = $this->exams->firstWhere('id', $examId); ?>
                    <!--[if BLOCK]><![endif]--><?php if($exam): ?>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#E2EFDA] text-[#217346]">
                            ...
                            <button wire:click="removeSelectedExam(<?php echo e($examId); ?>)" class="ml-1 focus:outline-none">
    ...
    <!-- Action Buttons -->
    <!--[if BLOCK]><![endif]--><?php if(count($selectedExams) > 1): ?>
        <div class="p-4 bg-gray-50 border-t border-gray-200">
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/combination-formula/_exam-table.blade.php ENDPATH**/ ?>