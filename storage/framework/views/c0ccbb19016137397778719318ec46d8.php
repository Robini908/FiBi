    ...
    <div class="flex-1 overflow-y-auto">
        <!--[if BLOCK]><![endif]--><?php if($searchTerm): ?>
            ...
            <div class="py-3">
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->getSearchResults(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <button 
                        ...
                        class="w-full px-4 py-3 flex items-center space-x-3 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition-colors duration-150 relative group 
                               <?php echo e($selectedUserId == $user['id'] ? 'bg-green-50 hover:bg-green-50' : ''); ?>"
                    >
                        <div class="flex-shrink-0">
                            <div class="relative">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($this->isOnline($user['id'])): ?>
        ...
        <?php else: ?>
            ...
            <div class="py-3">
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($unreadMessages) > 0): ?>
                    <h3 class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Unread Messages</h3>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $unreadMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button 
                            wire:click="selectUser(<?php echo e($user->id); ?>)"
                            wire:key="unread-<?php echo e($user->id); ?>"
                            class="w-full px-4 py-3 flex items-center space-x-3 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition-colors duration-150 relative group bg-green-50
                                   <?php echo e($selectedUserId == $user->id ? 'bg-green-100 hover:bg-green-100' : ''); ?>"
                        >
                            <div class="flex-shrink-0">
                                <div class="relative">
                                    <div class="h-12 w-12 rounded-full bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center text-white text-lg font-medium shadow-sm">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="text-xs text-gray-500 whitespace-nowrap ml-2">
                                        <?php echo e(($user->latestMessage && $user->latestMessage->created_at) ? $user->latestMessage->created_at->diffForHumans(null, true) : ''); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <!--[if BLOCK]><![endif]--><?php if(!in_array($user->id, collect($unreadMessages)->pluck('id')->toArray())): ?>
                        <button 
                            wire:click="selectUser(<?php echo e($user->id); ?>)"
                            wire:key="recent-<?php echo e($user->id); ?>"
                            class="w-full px-4 py-3 flex items-center space-x-3 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition-colors duration-150 relative group 
                                   <?php echo e($selectedUserId == $user->id ? 'bg-green-50 hover:bg-green-50' : ''); ?>"
                        >
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center justify-between mt-1">
                                    <p class="text-xs text-gray-500 truncate">
                                        <!--[if BLOCK]><![endif]--><?php if($user->latestMessage): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($user->latestMessage->sender_id == auth()->id()): ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/messages/partials/sidebar.blade.php ENDPATH**/ ?>