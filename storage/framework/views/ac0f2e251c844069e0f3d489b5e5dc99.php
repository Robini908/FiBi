...
<span 
    <?php echo e($attributes->merge(['class' => "inline-flex items-center {$colorClasses} {$sizeClasses} {$roundedClass} font-medium"])); ?>

    <?php if($removable && $onRemove): ?> 
        x-data="{}" 
        @click="$dispatch('<?php echo e($onRemove); ?>')"
    <?php endif; ?>
>
    <!--[if BLOCK]><![endif]--><?php if($icon && $iconPosition === 'left'): ?>
        <span class="inline-block <?php echo e($iconMarginClass); ?>"><?php echo $icon; ?></span>
    ...
    <!--[if BLOCK]><![endif]--><?php if($removable): ?>
        <button 
            type="button" 
            class="ml-1 -mr-0.5 flex-shrink-0 inline-flex <?php echo e($removeButtonColorClasses); ?> focus:outline-none"
            <?php if(!$onRemove): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</span> <?php /**PATH C:\projects\MbukuErp\resources\views/components/ui/badge.blade.php ENDPATH**/ ?>