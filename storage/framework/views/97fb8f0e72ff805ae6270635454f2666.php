    ...
    <div 
        ...
        <div class="px-6 py-4 bg-white" x-show="open" x-transition>
            ...
            <div class="mt-6 flex justify-center">
                <a href="<?php echo e(route('download.template')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/bulk-import/template-info.blade.php ENDPATH**/ ?>