        ...
        <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div class="flex-shrink-0">
                <!--[if BLOCK]><![endif]--><?php if($tempPhoto): ?>
                    <img 
                        src="<?php echo e($tempPhoto->temporaryUrl()); ?>" 
                        alt="Preview" 
            ...
            <div class="flex-1 space-y-4">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!str_contains($photo, 'ui-avatars.com')): ?>
                        <button 
                            type="button"
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $errors->get('tempPhoto'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/user-profile/photo-manager.blade.php ENDPATH**/ ?>