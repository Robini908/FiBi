    ...
    <div x-data="{ open: true }" class="mb-2">
        <div class="flex flex-wrap justify-between items-center mb-3">
            ...
            <div class="flex flex-wrap gap-2 mt-2 sm:mt-0">
                ...
                <!--[if BLOCK]><![endif]--><?php if($classId && $classes->firstWhere('id', $classId)): ?>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-50 text-purple-700">
                        Class: <?php echo e($classes->firstWhere('id', $classId)->name); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($sectionId && $sections->firstWhere('id', $sectionId)): ?>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-50 text-indigo-700">
                        Section: <?php echo e($sections->firstWhere('id', $sectionId)->name); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($teacherId && $teachers->firstWhere('id', $teacherId)): ?>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-50 text-yellow-700">
                        Teacher: <?php echo e($teachers->firstWhere('id', $teacherId)->name); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($subjectId && $subjects->firstWhere('id', $subjectId)): ?>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-red-50 text-red-700">
                        Subject: <?php echo e($subjects->firstWhere('id', $subjectId)->subject_name); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($showInactive): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($academicYear || $academicTerm || $classId || $sectionId || $teacherId || $subjectId || $showInactive): ?>
        ...
        <div x-show="open" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!--[if BLOCK]><![endif]--><?php if(is_array($year)): ?>
                                    <option value="<?php echo e($year['id']); ?>" <?php echo e(($year['id'] == $academicYear) ? 'selected' : ''); ?>>
                                        <?php echo e($year['name']); ?> <?php echo e(isset($year['is_current']) && $year['is_current'] ? '(Current)' : ''); ?>

                                    </option>
                                <?php elseif(is_object($year)): ?>
                                    <option value="<?php echo e($year->id); ?>" <?php echo e(($year->id == $academicYear) ? 'selected' : ''); ?>>
                                        <?php echo e($year->year); ?>

                                    </option>
                            <?php else: ?>
                                    <option value="<?php echo e($year); ?>" <?php echo e(($year == $academicYear) ? 'selected' : ''); ?>>
                                        <?php echo e($year); ?>
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $academicTerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($term); ?>" <?php echo e(($term == $academicTerm) ? 'selected' : ''); ?>><?php echo e($term); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        <select id="sectionId" wire:model.live="sectionId" class="block w-full rounded-md border-gray-300 pr-10 focus:border-blue-500 focus:ring-blue-500 text-sm" <?php echo e(count($sections) ? '' : 'disabled'); ?>>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/subject-teacher-assignment/filters.blade.php ENDPATH**/ ?>