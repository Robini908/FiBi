...
<div x-data="{ 
    ...
    stats: {
        ...
        teachers: <?php echo e(isset($users) ? $users->filter(function($user) { return $user->hasRole('teacher'); })->count() : 0); ?>,
        admins: <?php echo e(isset($users) ? $users->filter(function($user) { return $user->hasRole('admin'); })->count() : 0); ?>,
        parents: <?php echo e($totalParents ?? 0); ?>
...
[$__name, $__params] = $__split('dashboard.admin-charts', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1535980672-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('dashboard.teacher-charts', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1535980672-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('dashboard.parent-charts', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1535980672-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('dashboard.student-charts', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1535980672-3', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/pages/support_team/dashboard.blade.php ENDPATH**/ ?>