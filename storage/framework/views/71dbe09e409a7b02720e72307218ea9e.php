<div class="bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
            <div class="flex items-start">
                ...
                <div class="flex-shrink-0">
                    <!--[if BLOCK]><![endif]--><?php if($student && $student->photo): ?>
                        <img src="<?php echo e(asset($student->photo)); ?>" alt="<?php echo e($student->first_name); ?>" class="h-12 w-12 rounded-full object-cover border-2 border-gray-100 shadow-sm">
                    <?php else: ?>
                        <div class="h-12 w-12 rounded-full bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center shadow-sm border-2 border-gray-100">
                            <span class="text-green-700 font-medium text-sm">
                                <?php echo e($student ? substr($student->first_name, 0, 1) . substr($student->last_name, 0, 1) : 'N/A'); ?>
                ...
                <div class="ml-4 flex-1">
                    <h4 class="text-base font-medium text-gray-900">
                        <?php echo e($student ? $student->first_name . ' ' . $student->last_name : 'Student not found'); ?>

                    </h4>
                    <!--[if BLOCK]><![endif]--><?php if($student): ?>
                        <div class="mt-1 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                            <div class="text-gray-600">
                                <span class="font-medium text-gray-700">Admission No:</span> <?php echo e($student->adm_no); ?>

                            </div>
                            <div class="text-gray-600">
                                <span class="font-medium text-gray-700">Class:</span> 
                                <?php echo e($student->my_class->name ?? 'N/A'); ?> - <?php echo e($student->section->name ?? 'N/A'); ?>
        ...
        <div class="mb-6">
            ...
            <div class="bg-amber-50 rounded-md p-3 flex items-center">
                ...
                <span class="text-sm text-amber-800 font-medium">
                    <?php echo e($student ? ($student->suspension_end_date ? $student->suspension_end_date->format('l, F j, Y') : 'N/A') : 'Student not found.'); ?>
        ...
        <div class="mb-6">
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newSuspensionEndDate'];
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/suspensions/extend-form.blade.php ENDPATH**/ ?>