...
<div class="bg-white dark:bg-gray-50 rounded-lg shadow-sm overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-200 bg-gray-50 dark:bg-gray-100 flex justify-between items-center">
        <h2 class="font-medium text-xl text-gray-800 dark:text-gray-800 flex items-center">
            ...
            Students in <?php echo e($dormName); ?> - <?php echo e($year); ?>
    ...
    <div class="overflow-x-auto">
        <!--[if BLOCK]><![endif]--><?php if(isset($studentsInDorm) && count($studentsInDorm) > 0): ?>
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-200">
                ...
                <tbody class="bg-white dark:bg-white divide-y divide-gray-200 dark:divide-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $studentsInDorm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-50 transition-colors duration-150 ease-in-out">
                            <!-- Student -->
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <!--[if BLOCK]><![endif]--><?php if(isset($student->photo_by) && $student->photo_by): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="h-10 w-10 rounded-full bg-green-100 dark:bg-green-100 flex items-center justify-center">
                                                <span class="text-green-600 dark:text-green-600 font-medium text-sm">
                                                    <?php echo e(substr($student->first_name ?? $student->name ?? '', 0, 1)); ?><?php echo e(substr($student->last_name ?? '', 0, 1)); ?>
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 dark:text-gray-800">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(empty($student->first_name) && empty($student->last_name) && isset($student->name)): ?>
                                                <?php echo e($student->name); ?>

                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                        <div class="text-sm text-gray-500 dark:text-gray-600"><?php echo e($student->email ?? 'No email'); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <!-- Admission Number -->
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 dark:text-gray-800"><?php echo e($student->adm_no ?? 'N/A'); ?></div>
                            </td>
                            
                            <!-- Class -->
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 dark:text-gray-800">
                                    <!--[if BLOCK]><![endif]--><?php if(isset($student->my_class) && $student->my_class): ?>
                                        <?php echo e($student->my_class->name); ?>

                                    <?php elseif(isset($student->class_name)): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 dark:text-gray-800">
                                    <!--[if BLOCK]><![endif]--><?php if(isset($student->section) && $student->section): ?>
                                        <?php echo e($student->section->name); ?>

                                    <?php elseif(isset($student->section_name)): ?>
                                        <?php echo e($student->section_name); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <button 
                                    wire:click="removeStudent(<?php echo e($student->id); ?>)" 
            ...
            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-200">
                <?php echo e($studentsInDorm->links()); ?>
...
<?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/dorms/students-list.blade.php ENDPATH**/ ?>