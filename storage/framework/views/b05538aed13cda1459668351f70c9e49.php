...
<?php $__env->startSection('page_title', 'Grading System Management'); ?>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-5 border-b border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
[$__name, $__params] = $__split('grading-management', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-879069658-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('grading-range-manager', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-879069658-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('grade-manager', ['lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'lw-879069658-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\MbukuErp\resources\views/pages/support_team/grading_system/index.blade.php ENDPATH**/ ?>