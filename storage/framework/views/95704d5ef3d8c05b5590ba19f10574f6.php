            ...
            <div class="flex items-start">
                ...
                <div class="flex-shrink-0">
                    <!--[if BLOCK]><![endif]--><?php if($student && $student->photo): ?>
                        <img src="<?php echo e(asset($student->photo)); ?>" alt="<?php echo e($student->first_name); ?>" class="h-12 w-12 rounded-full object-cover">
                    <?php else: ?>
...
</div> <?php /**PATH C:\projects\MbukuErp\resources\views/livewire/partials/suspensions/reinstate-form.blade.php ENDPATH**/ ?>